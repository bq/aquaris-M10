...
static uint32_t mfm_i2s_Volume = 0x10000;
...
static const struct of_device_id mt_soc_pcm_fm_i2s_of_ids[] = {
	...
	{.compatible = "mediatek," MT_SOC_FM_I2S_PCM,},
	{}
};
MODULE_DEVICE_TABLE(of, mt_soc_pcm_fm_i2s_of_ids);
...
#endif
#ifdef CONFIG_OF
module_platform_driver(mtk_fm_i2s_driver);
#else
