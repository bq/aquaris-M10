...
#ifdef CONFIG_AW8737_SPEAKER_AMP
/* 0.75us<TL<10us; 0.75us<TH<10us */
#define GAP (2) //unit: us
#define AW8737_MODE1 /*1.2w/1.6w*/ \
    AudDrv_GPIO_EXTAMP_Select(true);

#define AW8737_MODE2 /*1.0w/1.3w*/ \
    AudDrv_GPIO_EXTAMP_Select(true); \
    udelay(GAP); \
    AudDrv_GPIO_EXTAMP_Select(false); \
    udelay(GAP); \
...
{
/*start-xmyyq-20161130-add speaker amp config*/
...
#define SPK_WARM_UP_TIME        (100)	/* unit is ms */
	...
	#define SPK_WARM_UP_TIME        (25)	/* unit is ms */
#endif
/*end-xmyyq-20161130-add speaker amp config*/
...
/*start-xmyyq-20161130-add speaker amp config*/
#if defined(CONFIG_AW8738_SPEAKER_AMP)
	#if defined(CONFIG_MT_SND_SOC_8163_H1003)
		AW8738_MODE2;
	#else
		AW8738_MODE5;
	#endif
#elif defined(CONFIG_AW8736_SPEAKER_AMP)
	#if defined(CONFIG_AW8736_SPEAKER_AMP_G1015)
			AW8736_MODE2;
	#else
			AW8736_MODE3;
	#endif
#elif defined(CONFIG_AW8737_SPEAKER_AMP)
	AW8737_MODE3;
#else
		AudDrv_GPIO_EXTAMP_Select(true);
#endif
/*end-xmyyq-20161130-add speaker amp config*/
		...
		mdelay(SPK_WARM_UP_TIME);/*xmyyq-20161130-Click no sound for the first time*/
#endif
	} else {
...
/*Fix the shutdown or reboot the speaker will cause noise*/
