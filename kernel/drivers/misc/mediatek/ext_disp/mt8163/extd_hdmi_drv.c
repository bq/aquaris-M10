...
{
	hdmi_drv->read(reg_val.u1adress, &reg_val.pu1Data);
}
...
void hdmi_config_pll(unsigned long resolutionmode)
{
    ...
    switch(resolutionmode)
    {
		...
		case HDMI_VIDEO_720x576p_50Hz:
			...
			udelay(10);			
			vWriteIoPllMsk(MHL_TVDPLL_CON1,(0x80109d89 << RG_TVDPLL_SDM_PCW),RG_TVDPLL_SDM_PCW_MASK);  //0x109d8a			
			//vWriteHdmiANAMsk(MHL_TVDPLL_CON1,0x80109d89,0x80109d89); /* Analog DE to confirmed, Enable CLKSQ */
			udelay(10);
		...
		case HDMI_VIDEO_1920x1080p3d_24Hz:
			...
			vWriteIoPllMsk(MHL_TVDPLL_PWR,0x0,RG_TVDPLL_SDM_ISO_EN);
			udelay(10);			
			vWriteIoPllMsk(MHL_TVDPLL_CON1,(0x8016D89D << RG_TVDPLL_SDM_PCW),RG_TVDPLL_SDM_PCW_MASK);  //16d89e
			//vWriteHdmiANAMsk(MHL_TVDPLL_CON1,(0x8016d2b5 << RG_TVDPLL_SDM_PCW),RG_TVDPLL_SDM_PCW_MASK);  //16d2b5
			udelay(10);
			//*(volatile unsigned int*)(0x1000c270) = (0x121); /*PLL Test Control Register 0 */
			vWriteIoPll(MHL_TVDPLL_CON0,0x121);
		...
		case HDMI_VIDEO_1920x1080p3d_23Hz:		
			...
			vWriteIoPllMsk(MHL_TVDPLL_PWR,0x0,RG_TVDPLL_SDM_ISO_EN);			
			udelay(10);			
			vWriteIoPllMsk(MHL_TVDPLL_CON1,(0x8016d2b5 << RG_TVDPLL_SDM_PCW),RG_TVDPLL_SDM_PCW_MASK);  //16d2b5
			
			//vWriteHdmiANAMsk(MHL_TVDPLL_CON1,(0x8016D89D << RG_TVDPLL_SDM_PCW),RG_TVDPLL_SDM_PCW_MASK);  //16d89e
			udelay(10);
			//*(volatile unsigned int*)(0x1000c270) = (0x121); /*PLL Test Control Register 0 */
			vWriteIoPll(MHL_TVDPLL_CON0,0x121);
