...
{
    if((pmsdc_boot_host)&&(id == pmsdc_boot_host->id))
        simp_msdc_dump_register(pmsdc_boot_host);
	
    if((pmsdc_extend_host) && (id == pmsdc_extend_host->id))
...
static unsigned int simp_msdc_init(struct simp_mmc_host *mmc_host)
{
    ...
    struct device_node *gpiobasen = NULL;
	void __iomem *gpiobase = NULL;
	
	gpiobasen = of_find_compatible_node(NULL, NULL, "mediatek,GPIO");
	gpiobase = of_iomap(gpiobasen, 0);
    ...
    switch(host->id){
        ...
        case 0:
			...
			*/
			...
			sdr_set_field(MSDC_CTRL(MSDC0, 1), BIT_MSDC_CMD_R0R1PUPD,  MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 3), BIT_MSDC_DAT0_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 3), BIT_MSDC_DAT1_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 3), BIT_MSDC_DAT2_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 3), BIT_MSDC_DAT3_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 4), BIT_MSDC_DAT4_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 4), BIT_MSDC_DAT5_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 4), BIT_MSDC_DAT6_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC0, 4), BIT_MSDC_DAT7_R0R1PUPD, MSDC_PST_PU_10KOHM);

            sdr_set_field(MSDC_CTRL(MSDC0, 6), MSDC_PAD_TDSEL(MSDC0),0x0A);
            sdr_set_field(MSDC_CTRL(MSDC0, 6), MSDC_PAD_RDSEL(MSDC0),0);
			
            //sdr_set_field(MSDC_CTRL(MSDC0, 1), MSDC_CLK_SMT(MSDC0),      1);
            sdr_set_field(MSDC_CTRL(MSDC0, 1), MSDC_CMD_SMT(MSDC0),      1);
            sdr_set_field(MSDC_CTRL(MSDC0, 3), MSDC_DAT_SMT(MSDC0,DAT0), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 3), MSDC_DAT_SMT(MSDC0,DAT1), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 3), MSDC_DAT_SMT(MSDC0,DAT2), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 3), MSDC_DAT_SMT(MSDC0,DAT3), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 4), MSDC_DAT_SMT(MSDC0,DAT4), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 4), MSDC_DAT_SMT(MSDC0,DAT5), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 4), MSDC_DAT_SMT(MSDC0,DAT6), 1);
            sdr_set_field(MSDC_CTRL(MSDC0, 4), MSDC_DAT_SMT(MSDC0,DAT7), 1);

			sdr_set_field(MSDC_CTRL(MSDC0, 0), BIT_MSDC_CLK_E8E4E2, msdc0_hw.clk_drv_sd_18);
			sdr_set_field(MSDC_CTRL(MSDC0, 1), BIT_MSDC_CMD_E8E4E2, msdc0_hw.cmd_drv_sd_18);
			sdr_set_field(MSDC_CTRL(MSDC0, 2), BIT_MSDC_DAT_E8E4E2, msdc0_hw.dat_drv_sd_18);
        ...
        case 1:
			...
			*/
			...
			sdr_set_field(MSDC_CTRL(MSDC1, 1), BIT_MSDC_CMD_R0R1PUPD,  MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT0_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT1_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT2_R0R1PUPD, MSDC_PST_PU_10KOHM);
			sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT3_R0R1PUPD, MSDC_PST_PU_10KOHM); 

			sdr_set_field(MSDC_CTRL(MSDC1,5), MSDC_PAD_TDSEL(MSDC1),0x0A);
			sdr_set_field(MSDC_CTRL(MSDC1,5), MSDC_PAD_RDSEL(MSDC1),0x0C);
			
           // sdr_set_field(MSDC_CTRL(MSDC1, 1), MSDC_CLK_SMT(MSDC1),      1);
            sdr_set_field(MSDC_CTRL(MSDC1, 1), MSDC_CMD_SMT(MSDC1),      1);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), MSDC_DAT_SMT(MSDC1,DAT0), 1);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), MSDC_DAT_SMT(MSDC1,DAT1), 1);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), MSDC_DAT_SMT(MSDC1,DAT2), 1);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), MSDC_DAT_SMT(MSDC1,DAT3), 1);

	        sdr_set_field(MSDC_CTRL(MSDC1, 0), BIT_MSDC_CLK_E8E4E2, msdc1_hw.clk_drv);
	        sdr_set_field(MSDC_CTRL(MSDC1, 1), BIT_MSDC_CMD_E8E4E2, msdc1_hw.cmd_drv);
	        sdr_set_field(MSDC_CTRL(MSDC1, 2), BIT_MSDC_DAT_E8E4E2, msdc1_hw.dat_drv);			
...
static int simp_mmc_init(int card_type,bool boot)
{
    ...
    if(boot){
			...
			MSDC_ASSERT(pmmc_boot_host->mtk_host->base);			
			...
			MSDC_ASSERT(pmmc_extend_host->mtk_host->base);			
        #else
...
#endif
    l_buf  = buf;
    if(   (pmsdc_extend_host) && (pmsdc_extend_host->card)
		&&(pmsdc_extend_host->card->card_cap == standard_capacity)) {
        l_addr = offset << 9;
    } else {
        l_addr = offset;
    }
