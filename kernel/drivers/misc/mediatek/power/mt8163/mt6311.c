...
{   
    ...
    {
        pr_info("[mt6311_hw_init] Unknown PMIC Chip (0x%x)\n", mt6311_get_chip_id());
    }
    //--------------------------------------------------------
}
...
{   
    ...
    #ifdef I2C_EXT_BUCK_CHANNEL // auto detect 
    {
        ...
        {
            pr_info("[mt6311_init] failed to register mt6311 i2c driver.\n");
        }
        else
        {
            pr_info("Power/PMIC","[mt6311_init] Success to register mt6311 i2c driver.\n");
        }
