...
int hw_otg_get_aca_type(void)
{
    ...
    if(1 == hw_bc11_ACA())
    {
         ...
         {             
             ACA_Type_num = ACA_A;
             pr_notice("step A1 : ACA_A, B device on accessory port!\r\n");
         }
         else
         {
             ...
             {             
                ACA_Type_num = ACA_A;
                pr_notice("step A2 : ACA_A, B device on accessory port!\r\n");
             }
             else
             {
			 	ACA_Type_num = ACA_DOCK;
                pr_notice("step A2 : ACA_DOCK, has external power source!\r\n");
             }
		 }
    }
    else
    {
         ...
         {
            ACA_Type_num = ACA_B;
            pr_notice("step B : ACA_B, only for charging!\r\n");
         ...
         else
         {
            ...
            {
               ACA_Type_num = ACA_C;
               pr_notice("step C : ACA_C, A device on accessory port!\r\n");

            }
            else
            {
               ACA_Type_num = ACA_UNKNOWN;
               pr_notice("step C : ACA_UNKNOWN !\r\n");
            }
         }
