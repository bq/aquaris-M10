...
0x14000000,0x14016000,0x14017000,0x10206000, 0x10000000, 0x100020F0, 0x10215000,0x10215800,0x14016200};
...
static int disp_probe(struct platform_device *pdev)
{
	...
	DPI_REG[0] = (PDPI_REGS)dispsys_reg[DISP_REG_DPI0];
	DPI_REG[1] = (PDPI_REGS)dispsys_reg[DISP_REG_DPI1];
