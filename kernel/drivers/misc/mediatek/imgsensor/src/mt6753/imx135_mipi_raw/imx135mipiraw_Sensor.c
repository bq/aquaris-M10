...
static void preview_setting(void)   /* PreviewSetting */
{
	...
	/* if (imgsensor.update_sensor_otp_lsc != 0) {} LukeHu--150324=For Kernel Coding Style. */
	/* else { LukeHu--150324=For Kernel Coding Style. */
	if (imgsensor.update_sensor_otp_lsc == 0) {/* LukeHu++150324=For Kernel Coding Style. */
	...
	/* gain setting */
	/* if (imgsensor.update_sensor_otp_awb != 0) {} LukeHu--150324=For Kernel Coding Style. */
	/* else { LukeHu--150324=For Kernel Coding Style. */
	if (imgsensor.update_sensor_otp_awb == 0) {/* LukeHu++150324=For Kernel Coding Style. */
...
/*Not Used //LukeHu++150326=For Build Warning
