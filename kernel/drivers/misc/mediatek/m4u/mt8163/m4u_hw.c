...
#define M4U1_PORT_INIT(port,tf_id)   1,0,4,port,tf_id, 1
...
m4u_port_t gM4uPort[] =
{
    ...
    { "DBG_I2C",                    M4U1_PORT_INIT( 0 ,  0x8    ),    },
    { "SPM",                        M4U1_PORT_INIT( 1 ,  0x28   ),    },
    { "MD32",                       M4U1_PORT_INIT( 2 ,  0x48   ),    },
    { "THERM",                      M4U1_PORT_INIT( 3 ,  0x68   ),    },    
    { "PWM",                        M4U1_PORT_INIT( 4 ,  0x04   ),    },
    { "MSDC1",                      M4U1_PORT_INIT( 5 ,  0x24   ),    },
    { "MSDC2",                      M4U1_PORT_INIT( 6 ,  0x44   ),    },    
    { "SPI0",                       M4U1_PORT_INIT( 7 ,  0x64   ),    },    
    { "NFI",/*HSIC_DMA_1P*/         M4U1_PORT_INIT( 8 ,  0x0    ),    },
    { "AUDIO",/*EITHER_NIC*/        M4U1_PORT_INIT( 9 ,  0x20   ),    },
    { "MSDC0",                      M4U1_PORT_INIT( 10,  0x40   ),    },
    { "HSIC_DMA_0P",                M4U1_PORT_INIT( 11,  0x60    ),    },
    
    { "HSIC_DMA_1P",                M4U1_PORT_INIT( 12,  0x0    ),    },
    { "EITHER_NIC",                 M4U1_PORT_INIT( 13,  0x20   ),    },    
    
    { "MSDC3",                      M4U1_PORT_INIT( 14,  0xC    ),    },    
    { "AP_DMA",                     M4U1_PORT_INIT( 15,  0x10   ),    },  
    { "UFO_ZIP_DEC",                M4U1_PORT_INIT( 16,  0x14   ),    },
    { "UFO_ZIP_ENC",                M4U1_PORT_INIT( 17,  0x18   ),    },
    { "DEBUG_MISS_TABLE_WALK",      M4U1_PORT_INIT( 18,  0x7C   ),    },    
    { "DEBUG_PREFETCH_TABLE_WALK",  M4U1_PORT_INIT( 19,  0x7D   ),    },    
    
    { "GPU",                        M4U1_PORT_INIT( 20,  0x0    ),    },
    
    { "UNKOWN",                     M4U1_PORT_INIT( 21,  0xF    ),    },
};
...
int m4u_invalid_tlb(int m4u_id,int L2_en, int isInvAll, unsigned int mva_start, unsigned int mva_end)
{
	...
	while (!M4U_ReadReg32(m4u_base, REG_MMU_CPE_DONE)) {
		i4Cnt++;
		if (i4Cnt > 100) {
			pr_err_ratelimited("M4U invalid don't done%d\n", m4u_id);
			i4Cnt = 0;
		}
	}
...
int m4u_reg_restore(int m4u_id)
{
    ...
    {
        m4u_aee_print("m4u_reg_retore %d %d!=%d\n", m4u_id, real_size, gM4u_reg_backup_real_size[m4u_id]);
    }
...
int m4u_hw_init(struct m4u_device *m4u_dev, int m4u_id)
{
    ...
    pM4URegBackUp = (unsigned int*)kmalloc(M4U_REG_BACKUP_SIZE*TOTAL_M4U_NUM, 
