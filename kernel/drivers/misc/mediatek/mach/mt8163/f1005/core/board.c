...
#if 0
static sdio_vender_irq_handler_t combo_sdio_eirq_handler = NULL;
...
void combo_audio_pin_conf(COMBO_AUDIO_STATE state)
{
	...
	static void combo_sdio_request_eirq(sdio_vender_irq_handler_t irq_handler, void *data)
	{
...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
...
#else 
        .flags          = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_DDR | MSDC_UHS1,
#endif	
        .dat0rddly      = 0,
        .dat1rddly      = 0,
        .dat2rddly      = 0,
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .data_offset          = 0,
#ifdef FPGA_PLATFORM
		.flags			= MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_CD_PIN_EN | MSDC_REMOVABLE,
#else         
        .flags          = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_DDR | MSDC_UHS1 | MSDC_CD_PIN_EN  /*| MSDC_REMOVABLE | MSDC_SD_NEED_POWER*/,
#endif
        .dat0rddly            = 0,
        .dat1rddly            = 0,
        .dat2rddly            = 0,
  ...
  #if defined(CONFIG_MTK_EMMC_SUPPORT)
    struct msdc_ett_settings msdc3_ett_settings[] = {
        /* common ett settings */
        { MSDC_HS200_MODE, 0xb0,  (0x7 << 7), 0x0 }, //PATCH_BIT0[MSDC_PB0_INT_DAT_LATCH_CK_SEL]
        { MSDC_HS200_MODE, 0xb0,  (0x1f<<10), 0x0 }, //PATCH_BIT0[MSDC_PB0_CKGEN_MSDC_DLY_SEL]
        { MSDC_HS400_MODE, 0xb0,  (0x7 << 7), 0x0 }, //PATCH_BIT0[MSDC_PB0_INT_DAT_LATCH_CK_SEL]
    ...
    struct msdc_hw msdc3_hw = {
		...
		.hclk_src		= MSDC50_CLKSRC4HCLK_182MHZ,
        .cmd_edge       = MSDC_SMPL_FALLING,
        .rdata_edge 	= MSDC_SMPL_FALLING,
        .wdata_edge 	= MSDC_SMPL_FALLING,
        .clk_drv        = 2,
        ...
        .cmdrddly       = 0,
        .ett_count      = 20, //should be same with ett_settings array size
        .ett_settings   = (struct msdc_ett_settings *)msdc3_ett_settings,
        .host_function	= MSDC_EMMC,
        .boot           = MSDC_BOOT_EN,
    };
  #else
