...
#define GPIO_CAMERA_FLASH_EN_PIN GPIO117
#endif
...
int FL_Init(void)
{
	...
	/* if(mt_set_gpio_mode(FLASH_GPIO_ENF,GPIO_MODE_00)){PK_DBG("set gpio mode failed!!\n");} */
	/* if(mt_set_gpio_dir(FLASH_GPIO_ENF,GPIO_DIR_OUT)){PK_DBG("set gpio dir failed!!\n");} */
	/* if(mt_set_gpio_out(FLASH_GPIO_ENF,GPIO_OUT_ZERO)){PK_DBG("et gpio failed!!\n");} */
