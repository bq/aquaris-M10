...
#define MP1_DBGAPB_BASE (dbgapb_base + (DBGAPB_CORE_OFFSET*4))
#define MCUCFG_BASE (mcucfg_base)      //0x1020_0000
...
#define MCUCFG_BASE (0x10200000)      //0x1020_0000
...
#define CPU_DORMANT_INFO(fmt, args...)		do { pr_notice("[Power/cpu_dormant] " fmt, ##args); } while(0)
#elif (CPU_DORMANT_LOG_PRINT == CPU_DORMANT_LOG_WITH_PRINTK)
#define CPU_DORMANT_INFO(fmt, args...)		do { pr_notice("[Power/cpu_dormant] " fmt, ##args); } while(0)
#endif

#define zlog(fmt, args...)		pr_notice("[Power/cpu_dormant] " fmt, ##args)
	...
	// init dormant_data
        ...
        if (1) { 
                ...
                zlog("dormant init aee_rec_cpu_dormant: va:%lx pa:%lx\n", 
                     (unsigned long)sleep_aee_rec_cpu_dormant_va, (unsigned long)sleep_aee_rec_cpu_dormant);
        }       
