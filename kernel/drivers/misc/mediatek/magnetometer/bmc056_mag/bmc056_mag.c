...
static int bmm050_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(client == NULL)
		return -1;
#endif
	printk("xmwuwh bmm050_i2c_probe 1\n");
	...
	printk("xmwuwh bmm050_i2c_probe 2\n");
	...
	printk("xmwuwh bmm050_i2c_probe 3\n");
	...
	printk("xmwuwh bmm050_i2c_probe 4\n");
...
#endif //BMC050_VG
printk("xmwuwh bmm050_i2c_probe 5\n");
