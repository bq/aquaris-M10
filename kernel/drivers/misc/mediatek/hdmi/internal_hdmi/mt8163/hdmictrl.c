...
void vSetHDMITxPLL(unsigned char bResIndex, unsigned char bdeepmode)
{
 ...
 // v4value2 = (*(volatile unsigned int*)(0xf02061c0))&0x003fffff;
  ...
  if(v4value1==0) v4value1 = 0x2d;
  if(v4value2==0) v4value2 = 0x2d2d2d;
...
void vConfigHdmiSYS(unsigned char bResIndex)
{
  ...
  if((bResIndex==HDMI_VIDEO_720x480p_60Hz)||(bResIndex==HDMI_VIDEO_720x576p_50Hz))
   ...
   if(_stAvdAVInfo.e_hdmi_aud_in == SV_SPDIF)
	vWriteHdmiSYSMsk(HDMI_SYS_CFG110,HDMI_SPDIF_CLK_EN, HDMI_SPDIF_CLK|HDMI_ADSP_CLK); 
   else
   vWriteHdmiSYSMsk(HDMI_SYS_CFG110,HDMI_SPDIF_CLK_EN|HDMI_ADSP_CLK_EN, HDMI_SPDIF_CLK|HDMI_ADSP_CLK); 
   ...
   vWriteHdmiTOPCKMsk(CLK_CFG_UPDATE, hdmi_ck_update | dpi1_ck_update, hdmi_ck_update | dpi1_ck_update);
