 ...
 */
Trunk 
Trunk_create_first_trunk_and_pivot(size_t size)
{
    Trunk first;
    Trunk pivot;
 ...
 */
void 
Trunk_release_list(Trunk trunk_head)
{
    Trunk pivot = trunk_head->pre;
 ...
 */
Trunk
Trunk_split_tail(Trunk current, size_t amount2)
{
...
Trunk
Trunk_split_front(Trunk current, size_t amount1)
{
...
Trunk
Trunk_free( Trunk target, Trunk first_trunk )
{
    Trunk   pre     = target->pre;
