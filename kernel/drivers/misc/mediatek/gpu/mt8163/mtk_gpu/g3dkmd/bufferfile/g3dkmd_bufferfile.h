...
typedef uintptr_t bf_file_fd_t ;
...
typedef struct _Bufferfile_DataBlock
{
    struct _Bufferfile_DataBlock *pNextDataBlock;
...
//---------------------------------------------------------------------
typedef struct _Bufferfile_File 
{
    struct _Bufferfile_File *pNextFile;
...
//    enum BUFFERFILE_STATE    status;
 ...
 //   DECLARE_MUTEX(bfDataLock);
    BufferfileDataBlock     *front;
    BufferfileDataBlock     *rear;
} BufferfileFile;
...
//---------------------------------------------------------------------
typedef struct _Queue_Bufferfile {
    BufferfileFile *front;            // head node
    BufferfileFile *rear;            // end node
} Queue_Bufferfile;
