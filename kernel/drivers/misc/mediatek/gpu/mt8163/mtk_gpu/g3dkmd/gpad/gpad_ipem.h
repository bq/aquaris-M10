...
enum gpad_ipem_callback {
	GPAD_IPEM_CALLBACK_TIMER           = 0, 
	GPAD_IPEM_CALLBACK_THERMAL         = 1, 
	GPAD_IPEM_CALLBACK_TOUCH           = 2, 
	GPAD_IPEM_CALLBACK_POWERLOW        = 3, 
	GPAD_IPEM_CALLBACK_POWERHIGH       = 4, 
	GPAD_IPEM_CALLBACK_POWEROFF        = 5, 
	GPAD_IPEM_CALLBACK_POWERON         = 6,
	GPAD_IPEM_CALLBACK_POWEROFF_BEGIN  = 7, 
	GPAD_IPEM_CALLBACK_POWEROFF_END    = 8, 
	GPAD_IPEM_CALLBACK_POWERON_BEGIN   = 9,
	GPAD_IPEM_CALLBACK_POWERON_END     = 10,
	GPAD_IPEM_CALLBACK_PERFORMANCE_ON  = 11,
	GPAD_IPEM_CALLBACK_PERFORMANCE_OFF = 12, 
	GPAD_IPEM_CALLBACK_LENGTH          = 13,
	GPAD_IPEM_CALLBACK_INVALID         = 13
};

enum gpad_ipem_event {
	GPAD_IPEM_EVENT_TIMER           = 0,
	GPAD_IPEM_EVENT_THERMAL         = 1,
	GPAD_IPEM_EVENT_TOUCH           = 2,
	GPAD_IPEM_EVENT_POWERLOW        = 3,
	GPAD_IPEM_EVENT_POWERHIGH       = 4,
	GPAD_IPEM_EVENT_POWEROFF        = 5,
	GPAD_IPEM_EVENT_POWERON         = 6,
	GPAD_IPEM_EVENT_POWEROFF_BEGIN  = 7,
	GPAD_IPEM_EVENT_POWEROFF_END    = 8,
	GPAD_IPEM_EVENT_POWERON_BEGIN   = 9,
	GPAD_IPEM_EVENT_POWERON_END     = 10,
	GPAD_IPEM_EVENT_PERFORMANCE_ON  = 11,
	GPAD_IPEM_EVENT_PERFORMANCE_OFF = 12,
	GPAD_IPEM_EVENT_LENGTH          = 13,
	GPAD_IPEM_EVENT_INVALID         = 13
};
