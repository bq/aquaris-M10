...
enum gpad_pm_sample_type {
    GPAD_PM_SAMPLE_SEGMENT = 0, 
    GPAD_PM_SAMPLE_SUBFRAME = 1,
    GPAD_PM_SAMPLE_FRAME = 2,
};
...
enum gpad_outpin_act {
    GPAD_OUTPIN_ACT_NONE = 0,
    GPAD_OUTPIN_ACT_PULSE = 1,
    GPAD_OUTPIN_ACT_UP = 2,
    GPAD_OUTPIN_ACT_DOWN = 3,
};
