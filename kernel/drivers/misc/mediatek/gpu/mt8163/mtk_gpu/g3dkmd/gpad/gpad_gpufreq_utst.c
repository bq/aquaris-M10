...
{
    {
        { .freq_khz = GPU_DVFS_F550, .volt = GPU_POWER_VGPU_1_25V, .power_mW = 1050, .lower_bound = 70, .upper_bound = 100 },
        { .freq_khz = GPU_DVFS_F480, .volt = GPU_POWER_VGPU_1_25V, .power_mW =  950, .lower_bound = 30, .upper_bound = 69 },
        { .freq_khz = GPU_DVFS_F380, .volt = GPU_POWER_VGPU_1_15V, .power_mW =  800, .lower_bound =  0, .upper_bound = 29 },
    },

    {
        { .freq_khz = GPU_DVFS_F550, .volt = GPU_POWER_VGPU_1_25V, .power_mW = 1050, .lower_bound = 40, .upper_bound = 100 },
        { .freq_khz = GPU_DVFS_F380, .volt = GPU_POWER_VGPU_1_15V, .power_mW =  800, .lower_bound =  0, .upper_bound = 39 },
    },
...
static s32 test_freq_(u32 const expected_freq, 
                      u32 const expected_volt) 
{
    u32 freq = 0;
    u32 volt = 0;
...
static s32 test_indices_(u32 const expected_bottom,
                         u32 const expected_limit,
                         u32 const expected_current)
{
    u32 bottom_index  = 0;
    u32 limit_index   = 0;
    u32 current_index = 0;

    gs_gpufreq_get_cur_indices(&bottom_index, 
                                &limit_index, 
                                &current_index);
...
static s32 test_hw_fv_(u32 const expected_freq, 
                       u32 const expected_volt) 
{
    u32 freq = 0;
    u32 volt = 0;
...
static struct test_list_type test_list[] = {
    { .init = 0x0000, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_smoke,           .name = "Smoke 1"   },
    { .init = 0x0004, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_smoke,           .name = "Smoke 2"   },
    { .init = 0x0014, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_smoke,           .name = "Smoke 3"   },
    { .init = 0x0040, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_smoke,           .name = "Table 0"   },
    { .init = 0x0020, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_smoke,           .name = "Table 1"   },
    { .init = 0x0010, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_smoke,           .name = "Table 2"   },
    { .init = 0x0110, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_basic,           .name = "basic 0"   },
    { .init = 0x0110, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_set_row,         .name = "basic 1" },
    { .init = 0x0110, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_unregister,      .name = "unregister" },
    { .init = 0x0110, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_basic_hw,        .name = "Basic HW" },
    { .init = 0x0110, .uninit = 0x0001, .param = 0x0000, .func = gpufreq_test_thermal,         .name = "Thermal" },
//    { .init = 0x0110, .uninit = 0x0000, .param = 0x0000, .func = gpufreq_test_thermal_row,     .name = "Thermal Row" },
};
