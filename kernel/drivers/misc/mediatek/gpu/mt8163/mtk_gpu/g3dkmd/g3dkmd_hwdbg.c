...
void g3dKmdHwDbgSetDumpFlushBase()
{
    g3dKmdRegWrite(G3DKMD_REG_MX, REG_MX_DBG_INTERNAL_DUMP, gMem.hwAddr, MSK_MX_DBG_DBG_DUMP_LDRAM_FLUSH_BASE, 0);
}

void g3dKmdHwDbgSetDumpReg( unsigned int value )
{
    g3dKmdRegWrite(G3DKMD_REG_MX, REG_MX_DBG_INTERNAL_DUMP, value, MSK_MX_DBG_DBG_DUMP_LDRAM_ENABLE, 0);
    g3dKmdRegWrite(G3DKMD_REG_MX, REG_MX_DBG_INTERNAL_DUMP, value, MSK_MX_DBG_DBG_DUMP_LDRAM_FLUSH_EN, 0);
}
...
{
    unsigned int temp = g3dKmdRegRead(G3DKMD_REG_MX, REG_MX_DBG_INTERNAL_DUMP, MSK_MX_DBG_DBG_DUMP_LDRAM_FLUSH_BASE, SFT_MX_DBG_DBG_DUMP_LDRAM_FLUSH_BASE);
