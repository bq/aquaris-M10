...
void gpad_dfd_interrupt_handler(unsigned int);
#endif /* GPAD_SUPPORT_DFD */

static volatile unsigned char *gpad_reg_base_s = NULL; /* GPU register base address. */
static volatile unsigned char *gpad_mmu_reg_base_s = NULL; /* GPU register base address. */
...
/* WorkAround: Not to Enable/Disable IPEM when PowerOn/PowerOff */  
//#if defined(GPAD_SUPPORT_DVFS)
...
int __init gpad_hal_open(void)
{
    ...
    static G3DKMD_KMIF_OPS ops = {
        .notify_g3d_hang = gpad_notify_g3d_hang,
        .notify_g3d_reset = gpad_notify_g3d_reset,
        .notify_g3d_early_suspend = gpad_notify_g3d_early_suspend,
        .notify_g3d_late_resume = gpad_notify_g3d_late_resume,
        .notify_g3d_power_low = gpad_notify_g3d_power_low,
        .notify_g3d_power_high = gpad_notify_g3d_power_high,
        .notify_g3d_power_off = gpad_notify_g3d_power_off,
        .notify_g3d_power_on = gpad_notify_g3d_power_on,
        .notify_g3d_power_off_begin = gpad_notify_g3d_power_off_begin,
        .notify_g3d_power_off_end = gpad_notify_g3d_power_off_end,
        .notify_g3d_power_on_begin = gpad_notify_g3d_power_on_begin,
        .notify_g3d_power_on_end = gpad_notify_g3d_power_on_end,
        .notify_g3d_dfd_interrupt = gpad_notify_g3d_dfd_interrupt,
        .notify_g3d_performance_mode = gpad_notify_g3d_performance_mode,
        .get_top_pm_counters = gpad_get_top_pm_counters,
    };
