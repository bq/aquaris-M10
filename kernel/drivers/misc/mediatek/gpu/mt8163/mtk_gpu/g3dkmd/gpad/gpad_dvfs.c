...
struct mtk_gpufreq_info gs_dvfs_tables[][4] =
{
    ...
    {
        { .freq_khz = GPU_DVFS_F480, .volt = GPU_POWER_VGPU_1_25V, .power_mW = 0, .lower_bound = 40, .upper_bound = 100 },
        { .freq_khz = GPU_DVFS_F380, .volt = GPU_POWER_VGPU_1_15V, .power_mW = 0, .lower_bound =  0, .upper_bound =  40 }
    },

    {
        { .freq_khz = GPU_DVFS_F550, .volt = GPU_POWER_VGPU_1_25V, .power_mW = 0, .lower_bound = 70, .upper_bound = 100 },
        { .freq_khz = GPU_DVFS_F480, .volt = GPU_POWER_VGPU_1_25V, .power_mW = 0, .lower_bound = 30, .upper_bound =  70 },
        { .freq_khz = GPU_DVFS_F380, .volt = GPU_POWER_VGPU_1_15V, .power_mW = 0, .lower_bound =  0, .upper_bound =  30 }
    },
};
...
int gpad_dvfs_init(struct gpad_device *dev)
{
    ...
    struct mtk_gpufreq_kmif kmif_ops = {
        .notify_thermal_event = gpad_dvfs_thermal_callback,
        .notify_touch_event = gpad_dvfs_touch_callback
    };
