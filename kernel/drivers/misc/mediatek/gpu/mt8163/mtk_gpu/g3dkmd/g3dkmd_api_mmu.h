...
#ifdef CMODEL
G3DKMD_APICALL unsigned int G3DAPIENTRY g3dKmdMmuG3dVaToVa(void* m, unsigned int g3d_va); // added by Frank Fu, 2012/12/21
#endif

G3DKMD_APICALL unsigned int G3DAPIENTRY g3dKmdMmuMap(void* m, void* va, unsigned int size, int could_be_section, unsigned int flag);
...
/// pattern
#ifdef YL_SECURE
G3DKMD_APICALL unsigned int G3DAPIENTRY g3dKmdRemapPhysical( void* va, unsigned int size, unsigned int secure_flag );
#else
...
/// swrdback 
void g3dKmdAllocSwRdback(struct _g3dExecuteInfo* execute, unsigned int size);
void g3dKmdFreeSwRdback(struct _g3dExecuteInfo* execute);
...
#ifdef YL_SECURE
extern unsigned int g3dKmdMmuMap_ex( void* m, void* va, unsigned int size, int could_be_section, unsigned int flag, unsigned int secure_flag);
#else
extern unsigned int g3dKmdMmuMap_ex( void* m, void* va, unsigned int size, int could_be_section, unsigned int flag);
#endif
