...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_PA_FRAME_EMPTY         0x00001000 // [default:1'b0][perf:] preempt and this frame is empty; (debug)
                                                  // 
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_ACCU_WG_Z           0xffffffff // [default:32'h0][perf:] Current local working group position Z
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_PRIM_DIFF_CNT       0xffffffff // [default:32'h0][perf:] VL and VX primitive difference count, due to backoff
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT0              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT1              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT2              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT3              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT4              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT5              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT6              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT7              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT8              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT9              0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT10             0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT11             0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT12             0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT13             0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT14             0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_DVCNT15             0xffffffff // [default:32'h0][perf:] Divisor count = floor(instance_id/divisor)
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_TFB_POINTER0        0x3fffffff // [default:30'h0][perf:] Current TFB write dram pointer0, 4 byte alignment.
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_TFB_POINTER1        0x3fffffff // [default:30'h0][perf:] Current TFB write dram pointer1, 4 byte alignment.
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_TFB_POINTER2        0x3fffffff // [default:30'h0][perf:] Current TFB write dram pointer2, 4 byte alignment.
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VL_TFB_POINTER3        0x3fffffff // [default:30'h0][perf:] Current TFB write dram pointer3, 4 byte alignment.
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VX_BS_HD_MAX_L_NO      0xff000000 // [default:8'h0][perf:] bin store table header max number L part
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VX_BS_HD_MAX_H_NO      0xff000000 // [default:8'h0][perf:] bin store table header max number H part
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VX_BS_TB_CBND_NO       0x000fffff // [default:20'h0][perf:] bin store table boundary number for clipping part
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_RSM_VX_BS_BK_CBND_NO       0x000fffff // [default:20'h0][perf:] bin store block boundary number for clipping part
                                                  // SAVE/RESTORE INFO
...
typedef struct
{
    ...
    union //0x0028, VL 
    {
        ...
        struct 
        {
            unsigned int vl_prim_diff_cnt     : 32; // VL and VX primitive difference count, due to backoff
                                                    // SAVE/RESTORE INFO
                                                    // default: 32'h0
        } s;
    ...
    union //0x0078, VL 
    {
        ...
        struct 
        {
            unsigned int vl_tfb_pointer0      : 30; // Current TFB write dram pointer0, 4 byte alignment.
                                                    // SAVE/RESTORE INFO
                                                    // default: 30'h0
        } s;
    }reg_vl_tfb_pointer0;
    ...
    union //0x007c, VL 
    {
        ...
        struct 
        {
            unsigned int vl_tfb_pointer1      : 30; // Current TFB write dram pointer1, 4 byte alignment.
                                                    // SAVE/RESTORE INFO
                                                    // default: 30'h0
        } s;
    }reg_vl_tfb_pointer1;
    ...
    union //0x0080, VL 
    {
        ...
        struct 
        {
            unsigned int vl_tfb_pointer2      : 30; // Current TFB write dram pointer2, 4 byte alignment.
                                                    // SAVE/RESTORE INFO
                                                    // default: 30'h0
        } s;
    }reg_vl_tfb_pointer2;
    ...
    union //0x0084, VL 
    {
        ...
        struct 
        {
            unsigned int vl_tfb_pointer3      : 30; // Current TFB write dram pointer3, 4 byte alignment.
                                                    // SAVE/RESTORE INFO
                                                    // default: 30'h0
        } s;
    }reg_vl_tfb_pointer3;
    ...
    union //0x00b4, VX 
    {
        ...
        struct 
        {
            unsigned int vx_bs_tb_cbnd_no     : 20; // bin store table boundary number for clipping part
                                                    // SAVE/RESTORE INFO
                                                    // default: 20'h0
    ...
    union //0x00b8, VX 
    {
        ...
        struct 
        {
            unsigned int vx_bs_bk_cbnd_no     : 20; // bin store block boundary number for clipping part
                                                    // SAVE/RESTORE INFO
                                                    // default: 20'h0
