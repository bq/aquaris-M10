...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_MCU2G3D_SET           0x00000001 // [default:1'b0][perf:] mcu to g3d engine set to control the fdq read/write pointer and htbuf read pointer, auto clear
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_G3D_IDLE_EXPIRE_CNT   0x0000ffff // [default:16'd64][perf:] the g3d idle timer expire credit counter 
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECLK_CGC10_EN         0xffffffff // [default:32'hffffffff][perf:] eclk clock gating control enable 10
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECLK_CGC11_EN         0xffffffff // [default:32'hffffffff][perf:] eclk clock gating control enable 11
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECLK_CGC12_EN         0xffffffff // [default:32'hffffffff][perf:] eclk clock gating control enable 12
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECLK_CGC13_EN         0xffffffff // [default:32'hffffffff][perf:] eclk clock gating control enable 13
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECLK_CGC14_EN         0xffffffff // [default:32'hffffffff][perf:] eclk clock gating control enable 14
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECLK_CGC15_EN         0xffffffff // [default:32'hffffffff][perf:] eclk clock gating control enable 15
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_CQ_HTBUF_START_ADDR   0xffffffff // [default:32'h0][perf:] cmdq(HT buffer) start address, must be 16 bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_CQ_HTBUF_END_ADDR     0xffffffff // [default:32'b0][perf:] cmdq(HT buffer) end address,must be 16bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_CQ_HTBUF_RPTR         0xffffffff // [default:32'b0][perf:] cmdq (ring buffer ):g3d read head /tail buffer read pointer 
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_CQ_HTBUF_WPTR         0xffffffff // [default:32'b0][perf:] cmdq (ring buffer ):sw wirte head/tail buffer write pointer
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_CQ_QLDING             0x00000002 // [default:][perf:] cq is loading  the queue buffer, for SW debug mode monitor
#define SFT_AREG_CQ_QLDING             1
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_ECC_HTBUF_RPTR        0xfffffff0 // [default:][perf:] read the error htbuffer read pointer when ecc happen
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FLUSH_LTC_EN       0x00000001 // [default:1'b0][perf:] sw flushes the g3d ltc according to apb bus.
#define SFT_AREG_PA_FLUSH_LTC_EN       0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_SYNC_SW_EN         0x00000002 // [default:1'b0][perf:] sw finish the program condition(for DWP), and set this signal tell g3d keep going 
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_SYNC_SW_DONE       0x00000002 // [default:][perf:] g3d stop g3d engine and wait sw program "pa_sync_sw_set" to release , and keep going.
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FDQBUF_BASE        0xffffffff // [default:32'b0][perf:] the frame base return data buffer base,16 byte alignment 
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FDQBUF_SIZE        0x001fffff // [default:21'b0][perf:] the frame base return data buffer size , max size 32MB, the unit is 8 Byte(64bits!!)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FDQ_HWWPTR         0x007ffff8 // [default:][perf:] the frame base return data buffer hw write pointer, the unit is 8byte , need set "mcu2g3d_set" before reading
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FDQ_SWRPTR         0x007ffff8 // [default:20'b0][perf:] the frame base return data buffer sw read pointer,the unit is 8byte
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FDQ_HWWPTR_RB_UPD  0x00000001 // [default:1'b0][perf:] roll back the pa frame data queue buffer hw write pointer update
#define SFT_AREG_PA_FDQ_HWWPTR_RB_UPD  0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PA_FDQ_HWWPTR_RB      0x007ffff8 // [default:20'b0][perf:] roll back the frame base return data buffer hw write pointer, the unit is 8byte , need set "mcu2g3d_set" to set
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_CQ_SNGBL_EN           0x00000002 // [default:1'b0][perf:] command queue set single mode request , no burst
...
#define MSK_AREG_MX_AXI_EVEN_WBL       0x00040000 // [default:1'h0][perf:] DDR4 AXI use
                                                  // 0 : normal, 1: wr burst lengh is even for DDR4
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VX_BINTBXR_4X         0x00000001 // [default:1'b0][perf:] bin table extend always read 4 times for mbin
                                                  // 0: backward  if possible
                                                  // 1: always 4 times
#define SFT_AREG_VX_BINTBXR_4X         0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VX_BINBKR_4X          0x00000002 // [default:1'b0][perf:] bin block always read 4 times for mbin
                                                  // 0: backward  if possible
                                                  // 1: always 4 times
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VX_BINHDR_THR         0x00001f00 // [default:5'h8][perf:] bin head buffer threshold (when lower than this threshold will generate reads to let buffer full)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL_IDXGEN_WATERLV     0x0000003f // [default:6'h20][perf:] vertex index read data buffer water level
#define SFT_AREG_VL_IDXGEN_WATERLV     0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL_INDIRECT_WRAP_MD   0x00000040 // [default:1'b0][perf:] DrawElementIndirect wrap on 32 bits or type bits 
                                                  // 0: wrap on 32 bits
                                                  // 1: wrap by type
#define SFT_AREG_VL_INDIRECT_WRAP_MD   6
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL_TFB_SAFE_MODE      0x00000080 // [default:1'b0][perf:] TransformFeedback safe mode, one 128bit write per component.
#define SFT_AREG_VL_TFB_SAFE_MODE      7
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL1_VXPBUF_LOWTH      0x0000ff00 // [default:8'd48][perf:] VX pbuf low threshold, for VL1 flush end condition
#define SFT_AREG_VL1_VXPBUF_LOWTH      8
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL1_VXPBUF_HIGHTH     0x00ff0000 // [default:8'd144][perf:] VX pbuf high threshold, for VL1 flush start condition
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL0_PRIMFIFO_LOWTH    0x000003ff // [default:10'd256][perf:] VL primfifo low threshold, for VL0 flush end condition
#define SFT_AREG_VL0_PRIMFIFO_LOWTH    0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_VL0_PRIMFIFO_HIGHTH   0x000ffc00 // [default:10'd510][perf:] VL primfifo high threshold, for VL0 flush start condition
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_MX_SECURE0_TOP_ADDR   0x000fffff // [default:20'b0][perf:] base address of secure range for Q buffer
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_RD_OFFSET             0x00000fff // [default:12'b0][perf:] read offset for queue/rsm/ frame / vp list base registers
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_RSMINFO_RD            0xffffffff // [default:][perf:] resume infomation read 
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PWC_CTRL_SNAP         0x00000010 // [default:1'b0][perf:] snap all counters and timestamp (also clear all internal counters)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PWC_SEL_DW_VPPIPE     0x00000001 // [default:1'b0][perf:] dw vppipe mux selection 0 for dw pwc counter1, dw pwc counter4
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PWC_TIMER             0xffffffff // [default:32'h00ffffff][perf:] timer to trigger snap, timestamp and interrupt (unit: cycle)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PWC_STMP              0xffffffff // [default:32'h0][perf:] timestamp, increased by one when (snap == 1) or (timer timeout)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PWC_COUNTER_DIS_0     0xffffffff // [default:32'h0][perf:] control separately 48 power counters in g3d_pwc
                                                  // 0: enable  1: disable
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PWC_COUNTER_DIS_1     0x0000ffff // [default:16'h0][perf:] control separately 48 power counters in g3d_pwc
                                                  // 0: enable  1: disable
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_M_RUN              0xffffffff // [default:32'h0][perf:] ignore m-1 unit, start to count from the m-th unit, unit is defined by 0xF00: pm_sample_level
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_DBG_BUS_SEL        0xffffffff // [default:32'h0][perf:] select which counter shown in Areg debug port
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_MXAXIR_CHSEL       0x001fffff // [default:21'h0][perf:] module mx, select MX rd channel into AXI for counting
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_MXAXIR_CHSEL_LC    0x00200000 // [default:1'b0][perf:] module mx, select MX rd lc (length cache) channel into AXI for counting
                                                  // 
                                                  // 
#define SFT_AREG_PM_MXAXIR_CHSEL_LC    21
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_MXAXI_CHSEL_EN     0x80000000 // [default:1'b0][perf:] enable MX channel count from AXI interface
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_MXAXIW_CHSEL       0x0000ffff // [default:16'h0][perf:] module mx, select MX wr channel into AXI for counting
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_MXAXIW_CHSEL_LC    0x00010000 // [default:1'b0][perf:] module mx, select MX wr lc (length cache) channel into AXI for counting
                                                  // 
                                                  // 
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_COUNTER_RESET      0xffffffff // [default:32'h0][perf:] for shader pm,  some counter value need reset while signal equal 0
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_GROUP_SEL       0xffffffff // [default:32'h0][perf:] all engine shared same debug mux select pin
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_CENTRAL_SEL_0   0x00000007 // [default:3'b0][perf:] select debug signal Bit15~Bit00 from which partition
                                                  // 0: DWP
                                                  // 1: MX
                                                  // 2: TX
                                                  // 3: FF
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_CENTRAL_SEL_1   0x00000070 // [default:3'b0][perf:] select debug signal Bit31~Bit16 from which partition
                                                  // As above
#define SFT_AREG_DEBUG_CENTRAL_SEL_1   4
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_CENTRAL_SEL_2   0x00000700 // [default:3'b0][perf:] select debug signal Bit47~Bit32 from which partition
                                                  // As above
#define SFT_AREG_DEBUG_CENTRAL_SEL_2   8
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_CENTRAL_SEL_3   0x00007000 // [default:3'b0][perf:] select debug signal Bit63~Bit48 from which partition
                                                  // As above
#define SFT_AREG_DEBUG_CENTRAL_SEL_3   12
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_CENTRAL_SEL_0      0x00070000 // [default:3'b0][perf:] select pm signal Bit7~Bit0 from which partition
                                                  // 0: DWP
                                                  // 1: MX
                                                  // 2: TX
                                                  // 3: FF
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_CENTRAL_SEL_1      0x00700000 // [default:3'b0][perf:] select pm signal Bit15~Bit8 from which partition
                                                  // As above
#define SFT_AREG_PM_CENTRAL_SEL_1      20
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_CENTRAL_SEL_2      0x07000000 // [default:3'b0][perf:] select pm signal Bit23~Bit16 from which partition
                                                  // As above
#define SFT_AREG_PM_CENTRAL_SEL_2      24
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_CENTRAL_SEL_3      0x70000000 // [default:3'b0][perf:] select pm signal Bit31~Bit24 from which partition
                                                  // As above
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_BUS_B0_SEL 0x00000007 // [default:3'h0][perf:] select debug io bit7 ~ bit0 from which byte
#define SFT_AREG_DEBUG_FINAL_BUS_B0_SEL 0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_BUS_B1_SEL 0x00000070 // [default:3'h1][perf:] select debug io bit15 ~ bit8 from which byte
#define SFT_AREG_DEBUG_FINAL_BUS_B1_SEL 4
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_BUS_B2_SEL 0x00000700 // [default:3'h2][perf:] select debug io bit23 ~ bit16 from which byte
#define SFT_AREG_DEBUG_FINAL_BUS_B2_SEL 8
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_BUS_B3_SEL 0x00007000 // [default:3'h3][perf:] select debug io bit31 ~ bit24 from which byte
#define SFT_AREG_DEBUG_FINAL_BUS_B3_SEL 12
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_TRIG_B0_SEL 0x00070000 // [default:3'h4][perf:] select debug trigger bit7 ~ bit0 from which byte
#define SFT_AREG_DEBUG_FINAL_TRIG_B0_SEL 16
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_TRIG_B1_SEL 0x00700000 // [default:3'h5][perf:] select debug trigger bit15 ~ bit8 from which byte
#define SFT_AREG_DEBUG_FINAL_TRIG_B1_SEL 20
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_TRIG_B2_SEL 0x07000000 // [default:3'h6][perf:] select debug trigger bit23 ~ bit16 from which byte
#define SFT_AREG_DEBUG_FINAL_TRIG_B2_SEL 24
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DEBUG_FINAL_TRIG_B3_SEL 0x70000000 // [default:3'h7][perf:] select debug trigger bit31 ~ bit24 from which byte
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_TIME_STAMP         0xffffffff // [default:32'h0][perf:] time stamp counts between pm_en rising and  falling. Time stamp will also be record to DRAM while flush
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_PM_COUNTER_EN         0xffffffff // [default:32'h0][perf:] turn off/on individual counters by the register
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_CTRL_FORCE_FRAME_LOAD 0x00000002 // [default:1'b0][perf:] Debug purpose. Override the frame_loaded indicator inside g3d_dbg_ctrl to 1
                                                  // 0: normal
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_TRIGGER_PIN_NUM 0x0001f000 // [default:5'h0][perf:] The pin number that trigger pin will replace with
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_FLUSH_INFO_EN 0x02000000 // [default:1'b0][perf:] When set, it will flush SRAM data to system memory at frame end
                                                  // 0: Will not flush
                                                  // 1: Will flush
#define SFT_AREG_DBG_DUMP_FLUSH_INFO_EN 25
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_INTO_REGISTER_EN 0x04000000 // [default:1'b0][perf:] Use register dbg_dump_data_dw* as storage
                                                  // 0: Use SRAM as storage
                                                  // 1: Use dbg_dump_data_dw*
#define SFT_AREG_DBG_DUMP_INTO_REGISTER_EN 26
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_STOP_WHEN_FULL 0x08000000 // [default:1'b1][perf:] Stop capturing data when the storage is full
                                                  // 0: Ring buffer mode
                                                  // 1: Stop capturing when storage is full
#define SFT_AREG_DBG_DUMP_STOP_WHEN_FULL 27
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_32K_MODE     0x10000000 // [default:1'b1][perf:] When set, Internal Dump will use only 32KB SRAM.
                                                  // This register is only valid when dbg_dump_into_register_en == 0
                                                  // 0: 64KB SRAM mode
                                                  // 1: 32KB SRAM mode
#define SFT_AREG_DBG_DUMP_32K_MODE     28
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_INTR_EN      0x20000000 // [default:1'b0][perf:] When set, Internal Dump will request interrupt when trigger condition hit. 
                                                  // 0: enable interrupt
                                                  // 1: disable interrupt
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_TARGET_FRAME_ID   0xffffffff // [default:32'h0][perf:] Target frame ID if dbg_target_frame_by == 2 or 3
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_TARGET_FRAME_CURR_OFFSET 0xffff0000 // [default:16'h0][perf:] Current hardware subframe offset count
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_C0_CHANGE     0x00000004 // [default:1'b0][perf:] Ignore the dbg_c0_pattern, c0hit if the bits selected by dbg_c0_mask are changed
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_C1_CHANGE     0x00000040 // [default:1'b0][perf:] Ignore the dbg_c1_pattern, c1hit if the bits selected by dbg_c1_mask are changed
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_C0_MASK       0xffffffff // [default:32'h0][perf:] Condition 0 mask of debug bus dedicate trigger
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_C0_PATTERN    0xffffffff // [default:32'h0][perf:] Condition 0 match pattern of debug bus dedicate trigger
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_C1_MASK       0xffffffff // [default:32'h0][perf:] Condition 1 mask of debug bus dedicate trigger
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_C1_PATTERN    0xffffffff // [default:32'h0][perf:] Condition 1 match pattern of debug bus dedicate trigger
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_VALUE_DW0     0xffffffff // [default:32'h0][perf:] The bit[31:0] value of debug bus. AKA value of debug out to pad
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_VALUE_DW1     0xffffffff // [default:32'h0][perf:] The bit[63:32] value of debug bus. AKA value of debug trigger
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_BUS_OCCURRED      0xffffffff // [default:32'h0][perf:] The bit[31:0] of debug bus has ever gone to high
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_FLUSH_CONTEXT_SWITCH 0x00000004 // [default:1'b0][perf:] Internal Dump flush when context switch happened
                                                  // 0: Normal mode
                                                  // 1: see context switch as frame end
#define SFT_AREG_DBG_DUMP_FLUSH_CONTEXT_SWITCH 2
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_FLUSH_BACKOFF 0x00000008 // [default:1'b0][perf:] Internal Dump flush when backoff happened
                                                  // 0: Normal mode
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_PROBE_SEL    0x0000ff00 // [default:8'h0][perf:] internal probe select. Only valid when dbg_dump_src_sel == 1.
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DW0_SEL      0x03000000 // [default:2'h0][perf:] Internal Dump Double Word 0 Data select if width overide
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DW1_SEL      0x0c000000 // [default:2'h1][perf:] Internal Dump Double Word 1 Data select if width overide
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DW2_SEL      0x30000000 // [default:2'h2][perf:] Internal Dump Double Word 2 Data select if width overide
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DW3_SEL      0xc0000000 // [default:2'h3][perf:] Internal Dump Double Word 3 Data select if width overide
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_BEGIN_COUNT  0xffffffff // [default:32'h0][perf:] Internal dump begin dump at the number of trigger hit count
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_END_COUNT    0xffffffff // [default:32'h0][perf:] Internal dump begin dump at the number of trigger hit count
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_CAPTURE_COUNT 0xffffffff // [default:32'h0][perf:] Internal dump begin dump at the number of trigger hit count
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_STATUS_FLUSH_BY_CS 0x01000000 // [default:1'b0][perf:] Indicate that last flush is caused by context switch
#define SFT_AREG_DBG_DUMP_STATUS_FLUSH_BY_CS 24
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_STATUS_FLUSH_BY_BO 0x02000000 // [default:1'b0][perf:] Indicate that last flush is caused by back off
#define SFT_AREG_DBG_DUMP_STATUS_FLUSH_BY_BO 25
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_STATUS_CS_OCCURRED 0x04000000 // [default:1'b0][perf:] Indicate that context switch has ever happened before last flush
#define SFT_AREG_DBG_DUMP_STATUS_CS_OCCURRED 26
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_STATUS_BO_OCCURRED 0x08000000 // [default:1'b0][perf:] Indicate that back off has ever happened before last flush
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DATA_DW0     0xffffffff // [default:32'h0][perf:] The dumpped data[31:0] when dbg_dmp_into_register_en == 1
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DATA_DW1     0xffffffff // [default:32'h0][perf:] The dumpped data[63:32] when dbg_dmp_into_register_en == 1
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DATA_DW2     0xffffffff // [default:32'h0][perf:] The dumpped data[95:64] when dbg_dmp_into_register_en == 1
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_DUMP_DATA_DW3     0xffffffff // [default:32'h0][perf:] The dumpped data[127:96] when dbg_dmp_into_register_en == 1
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_BY_TGT_FRAME 0x00000002 // [default:1'b0][perf:] If set, it will generate signature with the next target frame controlled by dbg_ctrl
                                                  // otherwise, it will generate with tne next frame
                                                  // 0: Next frame
                                                  // 1: Next target frame
#define SFT_AREG_DBG_IBSC_BY_TGT_FRAME 1
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_XY2ZP_CHECK_FFACE 0x00000004 // [default:1'b0][perf:] If set, IBSC will generate signature with xy2zp_fface
#define SFT_AREG_DBG_IBSC_XY2ZP_CHECK_FFACE 2
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_VL2UX_IGNORE_END 0x00000008 // [default:1'b0][perf:] If set, IBSC will generate signature without vl2ux_vs0_instend, vl2ux_vs0_listend, vl2ux_vs0_ndrend, vl2ux_vs0_wgend, vl2ux_vs1_instend and vl2ux_vs1_listend
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_READ_SEL     0x0000ff00 // [default:8'h0][perf:] Select which internal bus to put its signature at dbg_ibsc_signature register
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_VP_READY     0x01000000 // [default:1'b0][perf:] Indicate that VP phase bus signature is generating
#define SFT_AREG_DBG_IBSC_VP_READY     24
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_PP_READY     0x02000000 // [default:1'b0][perf:] Indicate that pP phase bus signature is generating
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_AREG_DBG_IBSC_VL2VX_ADDR_OFFSET 0xffffffff // [default:32'h0][perf:] The very first vl2vx qualified value when ibsc_enable asserted
...
typedef struct
{
    ...
    union //0x000c,  
    {
        ...
        struct 
        {
            unsigned int mcu2g3d_set          : 1 ; // mcu to g3d engine set to control the fdq read/write pointer and htbuf read pointer, auto clear
                                                    // default: 1'b0
        } s;
    }reg_mcu2g3d_set;
    ...
    union //0x0100,  
    {
        ...
        struct 
        {
            unsigned int cq_htbuf_start_addr  : 32; // cmdq(HT buffer) start address, must be 16 bytes alignment
                                                    // default: 32'h0
        } s;
    ...
    union //0x0104,  
    {
        ...
        struct 
        {
            unsigned int cq_htbuf_end_addr    : 32; // cmdq(HT buffer) end address,must be 16bytes alignment
                                                    // default: 32'b0
        } s;
    ...
    union //0x0108,  
    {
        ...
        struct 
        {
            unsigned int cq_htbuf_rptr        : 32; // cmdq (ring buffer ):g3d read head /tail buffer read pointer 
                                                    // default: 32'b0
        } s;
    }reg_cq_htbuf_rptr;
    ...
    union //0x010c,  
    {
        ...
        struct 
        {
            unsigned int cq_htbuf_wptr        : 32; // cmdq (ring buffer ):sw wirte head/tail buffer write pointer
                                                    // default: 32'b0
        } s;
    }reg_cq_htbuf_wptr;
    ...
    union //0x0188,  
    {
        ...
        struct 
        {
            ...
            unsigned int cq_qlding            : 1 ; // cq is loading  the queue buffer, for SW debug mode monitor
            unsigned int reserved1            : 2 ; 
            unsigned int ecc_htbuf_rptr       : 28; // read the error htbuffer read pointer when ecc happen
        } s;
    }reg_queue_status;
    ...
    union //0x0190,  
    {
        ...
        struct 
        {
            unsigned int pa_flush_ltc_en      : 1 ; // sw flushes the g3d ltc according to apb bus.
                                                    // default: 1'b0
            unsigned int pa_sync_sw_en        : 1 ; // sw finish the program condition(for DWP), and set this signal tell g3d keep going 
                                                    // default: 1'b0
        } s;
    ...
    union //0x0194,  
    {
        ...
        struct 
        {
            ...
            unsigned int pa_sync_sw_done      : 1 ; // g3d stop g3d engine and wait sw program "pa_sync_sw_set" to release , and keep going.
        } s;
    ...
    union //0x019c,  
    {
        ...
        struct 
        {
            unsigned int pa_fdqbuf_size       : 21; // the frame base return data buffer size , max size 32MB, the unit is 8 Byte(64bits!!)
                                                    // default: 21'b0
        } s;
    }reg_pa_fdqbuf_size;
    ...
    union //0x01a0,  
    {
        ...
        struct 
        {
            ...
            unsigned int pa_fdq_hwwptr        : 20; // the frame base return data buffer hw write pointer, the unit is 8byte , need set "mcu2g3d_set" before reading
        } s;
    }reg_pa_fdq_hwwptr;
    ...
    union //0x01a4,  
    {
        ...
        struct 
        {
            ...
            unsigned int pa_fdq_swrptr        : 20; // the frame base return data buffer sw read pointer,the unit is 8byte
                                                    // default: 20'b0
        } s;
    }reg_pa_fdq_swrptr;
    ...
    union //0x01a8,  
    {
        ...
        struct 
        {
            unsigned int pa_fdq_hwwptr_rb_upd : 1 ; // roll back the pa frame data queue buffer hw write pointer update
                                                    // default: 1'b0
            unsigned int reserved4            : 2 ; 
            unsigned int pa_fdq_hwwptr_rb     : 20; // roll back the frame base return data buffer hw write pointer, the unit is 8byte , need set "mcu2g3d_set" to set
                                                    // default: 20'b0
        } s;
    ...
    union //0x0304,  
    {
        ...
        struct 
        {
            ...
            unsigned int vx_dummy1            : 6 ; // dummy registers
                                                    // default: 6'h0
            unsigned int vx_binhdr_thr        : 5 ; // bin head buffer threshold (when lower than this threshold will generate reads to let buffer full)
                                                    // default: 5'h8
    ...
    union //0x0380,  
    {
        ...
        struct 
        {
            ...
            unsigned int vl_indirect_wrap_md  : 1 ; // DrawElementIndirect wrap on 32 bits or type bits 
                                                    ...
                                                    // 1: wrap by type
                                                    // default: 1'b0
            unsigned int vl_tfb_safe_mode     : 1 ; // TransformFeedback safe mode, one 128bit write per component.
                                                    // default: 1'b0
    ...
    union //0x0388,  
    {
        ...
        struct 
        {
            unsigned int vl0_primfifo_lowth   : 10; // VL primfifo low threshold, for VL0 flush end condition
                                                    // default: 10'd256
            unsigned int vl0_primfifo_highth  : 10; // VL primfifo high threshold, for VL0 flush start condition
                                                    // default: 10'd510
    ...
    union //0x0e0c,  
    {
        ...
        struct 
        {
            unsigned int rsminfo_rd           : 32; // resume infomation read 
        } s;
    }reg_rsminfo_rd;
    ...
    union //0x0d00,  
    {
        ...
        struct 
        {
            ...
            unsigned int pwc_ctrl_irq_en      : 1 ; // enable interrupt
                                                    // default: 1'b0
            unsigned int pwc_ctrl_snap        : 1 ; // snap all counters and timestamp (also clear all internal counters)
                                                    // default: 1'b0
    ...
    union //0x0d04,  
    {
        ...
        struct 
        {
            unsigned int pwc_sel_dw_vppipe    : 1 ; // dw vppipe mux selection 0 for dw pwc counter1, dw pwc counter4
                                                    // default: 1'b0
    ...
    union //0x0d0c,  
    {
        ...
        struct 
        {
            unsigned int pwc_stmp             : 32; // timestamp, increased by one when (snap == 1) or (timer timeout)
                                                    // default: 32'h0
        } s;
    }reg_pwc_stmp;
    ...
    union //0x0f04,  
    {
        ...
        struct 
        {
            unsigned int pm_m_run             : 32; // ignore m-1 unit, start to count from the m-th unit, unit is defined by 0xF00: pm_sample_level
                                                    // default: 32'h0
        } s;
    }reg_pm_m_run;
    ...
    union //0x0f14,  
    {
        ...
        struct 
        {
            unsigned int pm_mxaxir_chsel      : 21; // module mx, select MX rd channel into AXI for counting
                                                    ...
                                                    // [18]:vl_idx_rp [19]:vx_vtx_rp [20]: reserved
                                                    // default: 21'h0
            unsigned int pm_mxaxir_chsel_lc   : 1 ; // module mx, select MX rd lc (length cache) channel into AXI for counting
                                                    // 
                                                    // 
                                                    // default: 1'b0
    ...
    union //0x0f18,  
    {
        ...
        struct 
        {
            unsigned int pm_mxaxiw_chsel      : 16; // module mx, select MX wr channel into AXI for counting
                                                    // * Rd/Wr need pairs with pm_mxaxir_chsel  [0]: cp_c_wr* [1]: ux_vp_wr* [2]: zp_z_wr*
                                                    // [3]:vx_hc_wr*[4]:xy_cac_wr*[5]:vx_vtx_wr *
                                                    // [6]: vl_tfb_wr [7]: vx_bs_wr [8]:cq_cq_wp
                                                    // [9]:cp_c_wp [10]:cp_ebf_wp [11]:pe_pe_wp
                                                    ...
                                                    // [15]:pm_pm_wp
                                                    // default: 16'h0
            unsigned int pm_mxaxiw_chsel_lc   : 1 ; // module mx, select MX wr lc (length cache) channel into AXI for counting
                                                    // 
                                                    // 
                                                    // default: 1'b0
        } s;
    ...
    union //0x0f2c,  
    {
        ...
        struct 
        {
            unsigned int pm_counter_reset     : 32; // for shader pm,  some counter value need reset while signal equal 0
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f40,  
    {
        ...
        struct 
        {
            unsigned int pm_time_stamp        : 32; // time stamp counts between pm_en rising and  falling. Time stamp will also be record to DRAM while flush
                                                    // default: 32'h0
        } s;
    }reg_pm_time_stamp;
    ...
    union //0x0f60,  
    {
        ...
        struct 
        {
            unsigned int dbg_ctrl_enable      : 1 ; // Enable debug control logic
                                                    // default: 1'b0
            unsigned int dbg_ctrl_force_frame_load : 1 ; // Debug purpose. Override the frame_loaded indicator inside g3d_dbg_ctrl to 1
                                                    // 0: normal
                                                    // 1: force frame_loaded = 1
                                                    // default: 1'b0
            ...
            unsigned int dbg_dump_enable      : 1 ; // Enable Internal Dump
                                                    ...
                                                    // 1: Enable internal Dump
                                                    // default: 1'b0
            unsigned int dbg_dump_flush_info_en : 1 ; // When set, it will flush SRAM data to system memory at frame end
                                                    // 0: Will not flush
                                                    // 1: Will flush
                                                    // default: 1'b0
            ...
            unsigned int dbg_dump_32k_mode    : 1 ; // When set, Internal Dump will use only 32KB SRAM.
                                                    ...
                                                    // 1: 32KB SRAM mode
                                                    // default: 1'b1
            unsigned int dbg_dump_intr_en     : 1 ; // When set, Internal Dump will request interrupt when trigger condition hit. 
                                                    // 0: enable interrupt
                                                    // 1: disable interrupt
                                                    // default: 1'b0
    ...
    union //0x0f6c,  
    {
        ...
        struct 
        {
            ...
            unsigned int dbg_bus_c0_source    : 1 ; // condition 0 source
                                                    ...
                                                    // 1: from bus[31:0]
                                                    // default: 1'b0
            unsigned int dbg_bus_c0_change    : 1 ; // Ignore the dbg_c0_pattern, c0hit if the bits selected by dbg_c0_mask are changed
                                                    // default: 1'b0
            ...
            unsigned int dbg_bus_c1_source    : 1 ; // condition 1 source
                                                    ...
                                                    // 1: from bus[31:0]
                                                    // default: 1'b0
            unsigned int dbg_bus_c1_change    : 1 ; // Ignore the dbg_c1_pattern, c1hit if the bits selected by dbg_c1_mask are changed
                                                    // default: 1'b0
    ...
    union //0x0f74,  
    {
        ...
        struct 
        {
            unsigned int dbg_bus_c0_pattern   : 32; // Condition 0 match pattern of debug bus dedicate trigger
                                                    // It is useless when dbg_bus_c0_change = 1
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f78,  
    {
        ...
        struct 
        {
            unsigned int dbg_bus_c1_mask      : 32; // Condition 1 mask of debug bus dedicate trigger
                                                    // 0: condition 1 will never be hit
                                                    // default: 32'h0
        } s;
    }reg_dbg_bus_c1_mask;
    ...
    union //0x0f7c,  
    {
        ...
        struct 
        {
            unsigned int dbg_bus_c1_pattern   : 32; // Condition 1 match pattern of debug bus dedicate trigger
                                                    // It is useless when dbg_bus_c1_change = 1
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f80,  
    {
        ...
        struct 
        {
            unsigned int dbg_bus_value_dw0    : 32; // The bit[31:0] value of debug bus. AKA value of debug out to pad
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f84,  
    {
        ...
        struct 
        {
            unsigned int dbg_bus_value_dw1    : 32; // The bit[63:32] value of debug bus. AKA value of debug trigger
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f88,  
    {
        ...
        struct 
        {
            unsigned int dbg_bus_occurred     : 32; // The bit[31:0] of debug bus has ever gone to high
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f8c,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_flush_mode  : 2 ; // Internal Dump Fluh Mode
                                                    ...
                                                    // 3: reserved
                                                    // default: 2'h0
            unsigned int dbg_dump_flush_context_switch : 1 ; // Internal Dump flush when context switch happened
                                                    // 0: Normal mode
                                                    // 1: see context switch as frame end
                                                    // default: 1'b0
            ...
            unsigned int dbg_dump_probe_sel   : 8 ; // internal probe select. Only valid when dbg_dump_src_sel == 1.
                                                    // bit[7:4] means module select
                                                    // bit[3:0] means the bus select in the module
                                                    // For bit [7:4]
                                                    // 0: VL
            ...
            unsigned int dbg_dump_dw0_sel     : 2 ; // Internal Dump Double Word 0 Data select if width overide
                                                    // 0: dump data[31:0] = Input Data[31:0]
                                                    // 1: dump data[31:0] = input Data[63:32]
                                                    // 2: dump data[31:0] = input Data[95:64]
                                                    // 3: dump data[31:0] = input Data[127:96]
                                                    // default: 2'h0
            unsigned int dbg_dump_dw1_sel     : 2 ; // Internal Dump Double Word 1 Data select if width overide
                                                    // 0: dump data[63:32] = Input Data[31:0]
                                                    // 1: dump data[63:32] = input Data[63:32]
                                                    // 2: dump data[63:32] = input Data[95:64]
                                                    // 3: dump data[63:32] = input Data[127:96]
                                                    // default: 2'h1
            unsigned int dbg_dump_dw2_sel     : 2 ; // Internal Dump Double Word 2 Data select if width overide
                                                    // 0: dump data[95:64] = Input Data[31:0]
                                                    // 1: dump data[95:64] = input Data[63:32]
                                                    // 2: dump data[95:64] = input Data[95:64]
                                                    // 3: dump data[95:64] = input Data[127:96]
                                                    // default: 2'h2
            unsigned int dbg_dump_dw3_sel     : 2 ; // Internal Dump Double Word 3 Data select if width overide
                                                    // 0: dump data[127:96] = Input Data[31:0]
                                                    // 1: dump data[127:96] = input Data[63:32]
                                                    // 2: dump data[127:96] = input Data[95:64]
                                                    // 3: dump data[127:96] = input Data[127:96]
    ...
    union //0x0f90,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_begin_count : 32; // Internal dump begin dump at the number of trigger hit count
                                                    // 0: means begin capture when frame begins
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f94,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_end_count   : 32; // Internal dump begin dump at the number of trigger hit count
                                                    // 0: means no stop capturing
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f98,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_capture_count : 32; // Internal dump begin dump at the number of trigger hit count
                                                    // 0: means capture every cycle after triggered
                                                    // default: 32'h0
        } s;
    ...
    union //0x0f9c,  
    {
        ...
        struct 
        {
            ...
            unsigned int dbg_dump_status_flush_count : 8 ; // Internal Dump flush count
                                                    // default: 8'h0
            unsigned int dbg_dump_status_flush_by_cs : 1 ; // Indicate that last flush is caused by context switch
                                                    // default: 1'b0
            unsigned int dbg_dump_status_flush_by_bo : 1 ; // Indicate that last flush is caused by back off
                                                    // default: 1'b0
            unsigned int dbg_dump_status_cs_occurred : 1 ; // Indicate that context switch has ever happened before last flush
                                                    // default: 1'b0
            unsigned int dbg_dump_status_bo_occurred : 1 ; // Indicate that back off has ever happened before last flush
                                                    // default: 1'b0
    ...
    union //0x0fa0,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_data_dw0    : 32; // The dumpped data[31:0] when dbg_dmp_into_register_en == 1
                                                    // default: 32'h0
        } s;
    ...
    union //0x0fa4,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_data_dw1    : 32; // The dumpped data[63:32] when dbg_dmp_into_register_en == 1
                                                    // default: 32'h0
        } s;
    ...
    union //0x0fa8,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_data_dw2    : 32; // The dumpped data[95:64] when dbg_dmp_into_register_en == 1
                                                    // default: 32'h0
        } s;
    ...
    union //0x0fac,  
    {
        ...
        struct 
        {
            unsigned int dbg_dump_data_dw3    : 32; // The dumpped data[127:96] when dbg_dmp_into_register_en == 1
                                                    // default: 32'h0
        } s;
    ...
    union //0x0fb0,  
    {
        ...
        struct 
        {
            unsigned int dbg_ibsc_enable      : 1 ; // Enable Internal Bus Signature Check
                                                    ...
                                                    // 1: Enable
                                                    // default: 1'b0
            unsigned int dbg_ibsc_by_tgt_frame : 1 ; // If set, it will generate signature with the next target frame controlled by dbg_ctrl
                                                    // otherwise, it will generate with tne next frame
                                                    // 0: Next frame
                                                    // 1: Next target frame
                                                    // default: 1'b0
            unsigned int dbg_ibsc_xy2zp_check_fface : 1 ; // If set, IBSC will generate signature with xy2zp_fface
                                                    // default: 1'b0
            unsigned int dbg_ibsc_vl2ux_ignore_end : 1 ; // If set, IBSC will generate signature without vl2ux_vs0_instend, vl2ux_vs0_listend, vl2ux_vs0_ndrend, vl2ux_vs0_wgend, vl2ux_vs1_instend and vl2ux_vs1_listend
                                                    // default: 1'b0
            ...
            unsigned int dbg_isbc_dummy_3     : 1 ; // IBSC dummy register 3 for eco
                                                    // default: 1'b0
            unsigned int dbg_ibsc_read_sel    : 8 ; // Select which internal bus to put its signature at dbg_ibsc_signature register
                                                    // bit[15:12] means module select
                                                    // bit[11:8] means the bus select in the module
                                                    // For bit [15:12]
                                                    // 0: VL
    ...
    union //0x0fb8,  
    {
        ...
        struct 
        {
            unsigned int dbg_ibsc_vl2vx_addr_offset : 32; // The very first vl2vx qualified value when ibsc_enable asserted
                                                    // [31:0] = {vl2vx_v2_offset[3:0], vl2vx_v1_offset[3:0], vl2vx_v0_addr[23:0]}
                                                    // default: 32'h0
        } s;
    }reg_dbg_ibsc_vl2vx;
