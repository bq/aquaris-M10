...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_RSM                0x00000001 // [default:1'b0][perf:] command queue resume token, SW fill 0 , hw fill 1
                                                  // SAVE/RESTORE INFO
#define SFT_QREG_CQ_RSM                0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_FRAME_END             0x00000002 // [default:1'b0][perf:] if sw preempt and g3d finish with frame end , set this bit 1, sw init 0 
                                                  // SAVE/RESTORE INFO
#define SFT_QREG_FRAME_END             1
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_PMT_FM_IDX            0x000003fc // [default:8'b0][perf:] record the frame id in the current head/tail pointer
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_HTBUF_RPTR         0xffffffff // [default:32'b0][perf:] cmdq (ring buffer )head pointer, the head = tail at sw init
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_HTBUF_WPTR         0xffffffff // [default:32'b0][perf:] cmdq (ring buffer )tail pointer,the head = tail at sw init
                                                  // SAVE/RESTORE INFO
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_HTBUF_START_ADDR   0xffffffff // [default:32'h0][perf:] cmdq(HT buffer) start address, must be 16 bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_HTBUF_END_ADDR     0xffffffff // [default:32'b0][perf:] cmdq(HT buffer) end address,must be 16bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_RSM_START_ADDR     0xffffffff // [default:32'b0][perf:] cq resume buffer base start addr,must be 16bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_RSM_END_ADDR       0xffffffff // [default:32'b0][perf:] cq resume buffer base end addr,must be 16bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_RSMVPREG_START_ADDR 0xffffffff // [default:32'b0][perf:] cq resume vp registers buffer start addr,must be 16bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_CQ_RSMVPREG_END_ADDR  0xffffffff // [default:32'b0][perf:] cq resume vp registers buffer end addr,must be 16bytes alignment
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BINHD_BASE0        0xffffffff // [default:32'h1000000][perf:] buf0 bin header base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BINTB_BASE0        0xffffffff // [default:32'h2000000][perf:] buf0 bin table base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BINBK_BASE0        0xffffffff // [default:32'h3000000][perf:] buf0 bin block base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_VARY_BASE          0xffffffff // [default:32'h4000000][perf:] varying data base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BINHD_BASE1        0xffffffff // [default:32'h5000000][perf:] buf1 bin header base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BINTB_BASE1        0xffffffff // [default:32'h6000000][perf:] buf1 bin table base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BINBK_BASE1        0xffffffff // [default:32'h7000000][perf:] buf1 bin block base address, 128 byte align
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_VARY_MSIZE         0x0fffffff // [default:28'h200000][perf:] memory size of varying data, multiple of 4K bytes, max 256M
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_TB_MSIZE           0x0fffffff // [default:28'h100000][perf:] memory size of bin table, multiple of 16 bytes, max 256M
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BK_MSIZE           0x0fffffff // [default:28'h100000][perf:] memory size of bin block, multiple of 128 bytes, max 256M
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_VARY_PREBOFF_MSIZE 0x0fffffff // [default:28'h100000][perf:] pre full memory size of varying data, multiple of 1K bytes
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_TB_PREBOFF_MSIZE   0x0fffffff // [default:28'h100000][perf:] pre full memory size of bin table, multiple of 16 bytes
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_BK_PREBOFF_MSIZE   0x0fffffff // [default:28'h100000][perf:] pre full memory size of bin block, multiple of 128 bytes
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_VX_HD_PREBOFF_NUM     0x0000ffff // [default:16'hff00][perf:] pre full primitive number of bin header
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_MX_SECURE1_BASE_ADDR  0x000fffff // [default:20'd0][perf:] base address of secure range for frame cmd buffer
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_QREG_MX_SECURE1_TOP_ADDR   0x000fffff // [default:20'd0][perf:] top address of secure range for frame cmd buffer
...
typedef struct
{
    union //0x0000, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_rsm               : 1 ; // command queue resume token, SW fill 0 , hw fill 1
                                                    // SAVE/RESTORE INFO
                                                    // default: 1'b0
            unsigned int frame_end            : 1 ; // if sw preempt and g3d finish with frame end , set this bit 1, sw init 0 
                                                    // SAVE/RESTORE INFO
                                                    // default: 1'b0
    ...
    union //0x0004, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_htbuf_rptr        : 32; // cmdq (ring buffer )head pointer, the head = tail at sw init
                                                    // SAVE/RESTORE INFO
                                                    // default: 32'b0
        } s;
    }reg_cq_htbuf_rptr;
    ...
    union //0x0008, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_htbuf_wptr        : 32; // cmdq (ring buffer )tail pointer,the head = tail at sw init
                                                    // SAVE/RESTORE INFO
                                                    // default: 32'b0
        } s;
    }reg_cq_htbuf_wptr;
    ...
    union //0x0018, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_rsm_start_addr    : 32; // cq resume buffer base start addr,must be 16bytes alignment
                                                    // default: 32'b0
        } s;
    ...
    union //0x001c, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_rsm_end_addr      : 32; // cq resume buffer base end addr,must be 16bytes alignment
                                                    // default: 32'b0
        } s;
    }reg_cq_rsm_end_addr;
    ...
    union //0x0020, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_rsmvpreg_start_addr : 32; // cq resume vp registers buffer start addr,must be 16bytes alignment
                                                    // default: 32'b0
        } s;
    ...
    union //0x0024, CQ 
    {
        ...
        struct 
        {
            unsigned int cq_rsmvpreg_end_addr : 32; // cq resume vp registers buffer end addr,must be 16bytes alignment
                                                    // default: 32'b0
        } s;
    ...
    union //0x0044, VX 
    {
        ...
        struct 
        {
            unsigned int vx_vary_msize        : 28; // memory size of varying data, multiple of 4K bytes, max 256M
                                                    // (note: it is a ring buffer size, sum of buf0's, and buf1's size) 
                                                    // default: 28'h200000
        } s;
    }reg_vx_vary_msize;
    ...
    union //0x0050, VX 
    {
        ...
        struct 
        {
            unsigned int vx_vary_preboff_msize : 28; // pre full memory size of varying data, multiple of 1K bytes
                                                    // (note, it is the size for only buf0 or buf1)
                                                    // it should be <= vx_vary_msize/2 - vx_vw_buf_mgn
                                                    // default: 28'h100000
        } s;
    ...
    union //0x0054, VX 
    {
        ...
        struct 
        {
            unsigned int vx_tb_preboff_msize  : 28; // pre full memory size of bin table, multiple of 16 bytes
                                                    // it should be <= vx_tb_msize
                                                    // default: 28'h100000
        } s;
    ...
    union //0x0058, VX 
    {
        ...
        struct 
        {
            unsigned int vx_bk_preboff_msize  : 28; // pre full memory size of bin block, multiple of 128 bytes
                                                    // it sould be <= vx_bk_msize
                                                    // default: 28'h100000
        } s;
    ...
    union //0x0060, MX 
    {
        ...
        struct 
        {
            unsigned int mx_secure1_base_addr : 20; // base address of secure range for frame cmd buffer
                                                    // default: 20'd0
    ...
    union //0x0064, MX 
    {
        ...
        struct 
        {
            unsigned int mx_secure1_top_addr  : 20; // top address of secure range for frame cmd buffer
                                                    // default: 20'd0
        } s;
