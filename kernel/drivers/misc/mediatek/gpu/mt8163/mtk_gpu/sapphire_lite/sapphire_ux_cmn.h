...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_IN_STAGE_SID_EN     0x00010000 // [default:1'b0][perf:] input stage sequence id enable (enable sid count)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_IN_STAGE_SID_RST_SEL 0x00040000 // [default:1'b0][perf:] input stage sequence id reset select ([0]: pp_frame_flush [1]: vp_frame_rst)
#define SFT_UX_CMN_IN_STAGE_SID_RST_SEL 18
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_IFBSTOP_FORCE_EN    0x01000000 // [default:1'b0][perf:] IFB Engine Stop Force (All IFB Engine stop issuing instructions)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_IFBSTOP_RELEASE     0x40000000 // [default:1'b0][perf:] IFB Engine Release (All Stopped Engine are released)
#define SFT_UX_CMN_IFBSTOP_RELEASE     30
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_DEBUG_EN            0x80000000 // [default:1'b0][perf:] Debug Enable for data latch (read/dump eu_status_data should active this bit)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_UX_ACTIVITY_TIMEOUT 0xffffffff // [default:32'hffff_ffff][perf:] ux activity timeout threshold (cycles)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_UX_RETIRE_TIMEOUT   0xffffffff // [default:32'hffff_ffff][perf:] ux retire timeout threshold (cycles)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_EN           0x00000001 // [default:1'b0][perf:] advanced debug enable (stop in specific condition)
#define SFT_UX_CMN_ADVDBG_EN           0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_TYPE         0x00000030 // [default:2'd0][perf:] advanced debug type(0~2: VS0/VS1/FS/CL)
#define SFT_UX_CMN_ADVDBG_TYPE         4
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_CHK_MODE     0x00000040 // [default:1'b0][perf:] advanced debug check mode (0: one condition meets  1: all conditions meet)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_CHK_IBASE_EN 0x00000200 // [default:1'b0][perf:] advanced debug check instruction base enable
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_SID          0xffffffff // [default:32'hffff_ffff][perf:] advanced debug sid (debug would stop when cur_sid>=reg_sid)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_IBASE        0xffffffff // [default:32'hffff_ffff][perf:] advanced debug ibase (debug would stop when cur_ibase==reg_ibase)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ADVDBG_LASTPC       0x000fffff // [default:20'hf_ffff][perf:] advanced debug sid (debug would stop when cur_lastpc>=reg_lastpc)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_CRF_DBG_WPSEL       0x00000030 // [default:2'd0][perf:] cprf debug wave pool select (0/1/2/3)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_ISC_DBG_RD_RDSEL    0x0000000c // [default:2'd0][perf:] isc debug read select (bit0:low/high select bit1: partial enable)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_EU_STATUS_ID_A      0x0000000f // [default:4'd0][perf:] eu status id (0:cxm 1:tks 2:cpu 3:lsu 4:cpl1 5:vpl1 6:isc 7:fsi 8:vs0i 9:vs1i 10:fsrr 11:vs0r 12:vs1r)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_EU_STATUS_ID_B      0x0000000f // [default:4'd0][perf:] eu status id (0:cxm 1:tks 2:cpu 3:lsu 4:cpl1 5:vpl1 6:isc 7:fsi 8:vs0i 9:vs1i 10:fsrr 11:vs0r 12:vs1r)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_CXM_GLOBAL_CID      0x0000000f // [default:4'd0][perf:] context global cid (0~3: FS/CL 6:VS0 7:VS1)
#define SFT_UX_CMN_CXM_GLOBAL_CID      0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_CXM_GLOBAL_SEL      0x000001f0 // [default:5'd0][perf:] context/frame global select (0~15: context global 16~31: frame global)
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_INPUT_STAGE_IO      0x0003ffff // [default:][perf:] {vs0i_rdy,vs0i_ack,vs0i2tks_rdy, tks2vs0i_ack, vs0i2smm_rdy,smm2vs0i_ack,
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_OUTPUT_STAGE_IO     0xff000000 // [default:][perf:] {ux2vl_vs0_rdy,vl2ux_vs0_ack,ux2vl_vs1_rdy,vl2ux_vs1_ack,ux2vx_rdy,vx2ux_ack,
                                                  // ux2cp_rdy,cp2ux_ack}
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_TX_IO               0x000003ff // [default:][perf:] {ux2tx_rdy,tx2ux_ack,ux2tx_idx_rdy,tx2ux_idx_ack,ux2tx_pix_rdy,tx2ux_pix_ack,
                                                  // ux2tx_glbini_rdy,tx2ux_glbini_ack,ux2tx_glbclr_rdy,tx2ux_glbclr_ack}
#define SFT_UX_CMN_TX_IO               0
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_LTC_IO              0x00ff0000 // [default:][perf:] {ux2mx_cp_rd_req,mx2ux_cp_rd_ack,ux2mx_ic_rd_req,mx2ux_ic_rd_ack,
...
/*--------------------------------------------------------------------------------------------------------*/
#define MSK_UX_CMN_IDLE_STATUS         0x000007ff // [default:][perf:] {cpu,lsu,isc,vpl1,cpl1,vs0i,vs1i,fsi,vs0r,vs1r,fsr}
...
typedef struct
{
    union //0x0000,  
    {
        ...
        struct 
        {
            ...
            unsigned int in_stage_sid_rsv0    : 1 ; // reserved
                                                    // default: 1'b0
            unsigned int in_stage_sid_rst_sel : 1 ; // input stage sequence id reset select ([0]: pp_frame_flush [1]: vp_frame_rst)
                                                    // default: 1'b0
            unsigned int reserved1            : 5 ; 
            unsigned int ifbstop_force_en     : 1 ; // IFB Engine Stop Force (All IFB Engine stop issuing instructions)
                                                    // default: 1'b0
            ...
            unsigned int ifbstop_release      : 1 ; // IFB Engine Release (All Stopped Engine are released)
                                                    // default: 1'b0
            unsigned int debug_en             : 1 ; // Debug Enable for data latch (read/dump eu_status_data should active this bit)
                                                    // default: 1'b0
        } s;
    }reg_debug_enable;
    ...
    union //0x0014,  
    {
        ...
        struct 
        {
            ...
            unsigned int advdbg_type          : 2 ; // advanced debug type(0~2: VS0/VS1/FS/CL)
                                                    // default: 2'd0
            unsigned int advdbg_chk_mode      : 1 ; // advanced debug check mode (0: one condition meets  1: all conditions meet)
                                                    // default: 1'b0
    ...
    union //0x0018,  
    {
        ...
        struct 
        {
            unsigned int advdbg_sid           : 32; // advanced debug sid (debug would stop when cur_sid>=reg_sid)
                                                    // default: 32'hffff_ffff
        } s;
    }reg_adv_debug_1;
    ...
    union //0x001c,  
    {
        ...
        struct 
        {
            unsigned int advdbg_ibase         : 32; // advanced debug ibase (debug would stop when cur_ibase==reg_ibase)
                                                    // default: 32'hffff_ffff
        } s;
    }reg_adv_debug_2;
    ...
    union //0x0020,  
    {
        ...
        struct 
        {
            unsigned int advdbg_lastpc        : 20; // advanced debug sid (debug would stop when cur_lastpc>=reg_lastpc)
                                                    // default: 20'hf_ffff
        } s;
    }reg_adv_debug_3;
    ...
    union //0x003c,  
    {
        ...
        struct 
        {
            ...
            unsigned int isc_dbg_rd_fire      : 1 ; // isc debug read fire (1T pulse)
                                                    // default: 1'b0
            unsigned int isc_dbg_rd_rdsel     : 2 ; // isc debug read select (bit0:low/high select bit1: partial enable)
                                                    // default: 2'd0
    ...
    union //0x0048,  
    {
        ...
        struct 
        {
            unsigned int eu_status_id_a       : 4 ; // eu status id (0:cxm 1:tks 2:cpu 3:lsu 4:cpl1 5:vpl1 6:isc 7:fsi 8:vs0i 9:vs1i 10:fsrr 11:vs0r 12:vs1r)
                                                    // default: 4'd0
    ...
    union //0x0050,  
    {
        ...
        struct 
        {
            unsigned int eu_status_id_b       : 4 ; // eu status id (0:cxm 1:tks 2:cpu 3:lsu 4:cpl1 5:vpl1 6:isc 7:fsi 8:vs0i 9:vs1i 10:fsrr 11:vs0r 12:vs1r)
                                                    // default: 4'd0
    ...
    union //0x0058,  
    {
        ...
        struct 
        {
            unsigned int cxm_global_cid       : 4 ; // context global cid (0~3: FS/CL 6:VS0 7:VS1)
                                                    // default: 4'd0
            unsigned int cxm_global_sel       : 5 ; // context/frame global select (0~15: context global 16~31: frame global)
                                                    // default: 5'd0
        } s;
    ...
    union //0x0070,  
    {
        ...
        struct 
        {
            unsigned int input_stage_io       : 18; // {vs0i_rdy,vs0i_ack,vs0i2tks_rdy, tks2vs0i_ack, vs0i2smm_rdy,smm2vs0i_ack,
                                                    //  vs1i_rdy,vs1i_ack,vs1i2tks_rdy, tks2vs1i_ack, vs1i2smm_rdy,smm2vs1i_ack,
                                                    //  fsi_rdy,   fsi_ack,   fsi2tks_rdy,   tks2fsi_ack,   fsi2smm_rdy,  smm2fsi_ack}
            unsigned int reserved10           : 6 ; 
            unsigned int output_stage_io      : 8 ; // {ux2vl_vs0_rdy,vl2ux_vs0_ack,ux2vl_vs1_rdy,vl2ux_vs1_ack,ux2vx_rdy,vx2ux_ack,
                                                    // ux2cp_rdy,cp2ux_ack}
        } s;
    ...
    union //0x0074,  
    {
        ...
        struct 
        {
            unsigned int tx_io                : 10; // {ux2tx_rdy,tx2ux_ack,ux2tx_idx_rdy,tx2ux_idx_ack,ux2tx_pix_rdy,tx2ux_pix_ack,
                                                    // ux2tx_glbini_rdy,tx2ux_glbini_ack,ux2tx_glbclr_rdy,tx2ux_glbclr_ack}
            unsigned int reserved11           : 6 ; 
            unsigned int ltc_io               : 8 ; // {ux2mx_cp_rd_req,mx2ux_cp_rd_ack,ux2mx_ic_rd_req,mx2ux_ic_rd_ack,
                                                    // ux2mx_vp_rd_req,mx2ux_vp_rd_ack,ux2mx_vp_wr_req,mx2ux_vp_wr_ack}
        } s;
