...
static void GetAudioTrimOffset(int channels)
{
    ...
    printk("GetAudioTrimOffset, channels = %d\n", channels);
    ...
    printk("GetAudioTrimOffset, Buffer_offl_value = %d\n", Buffer_offl_value);
    
    Buffer_offr_value = PMIC_IMM_GetOneChannelValue(AUXADC_HP_R_CHANNEL, off_counter, 0);
    printk("GetAudioTrimOffset, Buffer_offr_value = %d\n", Buffer_offr_value);
    ...
    printk("GetAudioTrimOffset, mHplOffset = %d, mHprOffset = %d\n", mHplOffset, mHprOffset);
