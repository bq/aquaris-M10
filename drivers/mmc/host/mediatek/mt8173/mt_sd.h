...
/* misc register */
#define MSDC_PATCH_BIT              REG_ADDR(MSDC_PATCH_BIT0)
...
#define MSDC_PAD_TUNE               REG_ADDR(MSDC_PAD_TUNE0)
...
#define MSDC_PAD_TUNE0_DATRRDLY      (0x1F <<  8)	/*  */
...
struct msdc_host {
	...
	void __iomem *top;	/* host top address */
	int id;			/* host id */
	...
	u8 card_selected;	/* card selected ? */
...
static inline bool support_sdio_data_tune(void)
{
	return !(mt_get_chip_sw_ver() == CHIP_SW_VER_01);
}
