...
{
	return mtk_spec_get_ies_smt_range(regmap, mt8167_ies_set, ARRAY_SIZE(mt8167_ies_set), pin);
}

static int mt8167_spec_smt_get(struct regmap *regmap, unsigned int pin)
{
	return mtk_spec_get_ies_smt_range(regmap, mt8167_smt_set, ARRAY_SIZE(mt8167_smt_set), pin);
}
