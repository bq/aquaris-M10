...
static int mt8127_spec_ies_get(struct regmap *regmap, unsigned int pin)
{
	return mtk_spec_get_ies_smt_range(regmap, mt8127_ies_set,
		ARRAY_SIZE(mt8127_ies_set), pin);
}

static int mt8127_spec_smt_get(struct regmap *regmap, unsigned int pin)
{
	return mtk_spec_get_ies_smt_range(regmap, mt8127_smt_set,
		ARRAY_SIZE(mt8127_smt_set), pin);
}

static int mt8127_spec_pull_get(struct regmap *regmap, unsigned int pin)
{
	return mtk_spec_pull_get_samereg(regmap, mt8127_spec_pupd,
		ARRAY_SIZE(mt8127_spec_pupd), pin);
}
...
static const struct mtk_pinctrl_devdata mt8127_pinctrl_data = {
	...
	.spec_pull_get = mt8127_spec_pull_get,
	.spec_ies_get = mt8127_spec_ies_get,
	.spec_smt_get = mt8127_spec_smt_get,
	.dir_offset = 0x0000,
