 ...
 * as published by the Free Software Foundation, and any use by you of this program is subject to the terms
 * of such GNU licence.
 *
...
void mali_core_scaling_update(struct mali_gpu_utilization_data *data)
{
	...
	if (PERCENT_OF(90, 256) < data->utilization_pp)
		...
		/* do nothing */
		MALI_DEBUG_PRINT(5, ("do nothing\n"));
	else if (PERCENT_OF(0, 256) < data->utilization_pp)
		disable_one_core();
	else
		/* do nothing */
		MALI_DEBUG_PRINT(5, ("else do nothing\n"));
}
