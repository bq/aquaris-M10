...
void PMIC_INIT_SETTING_V1(void)
{
	...
	if (chip_version >= PMIC6323_E2_CID_CODE) {
		...
		/*start-xmyyq-20161121-modify 9v charger OVP config*/
#ifdef CONFIG_HIGH_VOLTAGE_CHARGER
		ret = pmic_config_interface(0x2, 0xF, 0xF, 4);	/* [7:4]: RG_VCDT_HV_VTH; 10.5V OVP */
#else
		ret = pmic_config_interface(0x2, 0xB, 0xF, 4);	/* [7:4]: RG_VCDT_HV_VTH; 7V OVP */
#endif
		/*endif-xmyyq-20161121-modify 9v charger OVP config*/
		ret = pmic_config_interface(0x2, 0xB, 0xF, 4);	/* [7:4]: RG_VCDT_HV_VTH; 7V OVP */
		#ifdef HIGH_BATTERY_VOLTAGE_SUPPORT
