...
printk("xmhhs this is h1010 for camera \n");
	...
	if (On) {
    printk("xmhhs this is h1010 for camera %s \n",currSensorName);
		ISP_MCLK1_EN(1);
		if (pinSetIdx == 0 && currSensorName && ((0 == strcmp(currSensorName, SENSOR_DRVNAME_OV5648_MIPI_RAW)) || (0 == strcmp(currSensorName, SENSOR_DRVNAME_HM5040_MIPI_RAW))||(0 == strcmp(currSensorName, SENSOR_DRVNAME_HM5040MIPI_RAW)))) {
		...
		else if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV2681_MIPI_RAW))) {
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
        ...
        else if(pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV8858_MIPI_RAW)))
					{
            			 mdelay(1);
       ...
       else if((0 == strcmp(SENSOR_DRVNAME_GC2355_MIPI_RAW, currSensorName)))
       	{
			mdelay(1);
        ...
        mtkcam_gpio_set(1-pinSetIdx, CAMPDN, pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
         ...
         else if((0 == strcmp(SENSOR_DRVNAME_GC0339_MIPI_RAW, currSensorName)))
       	{
			mdelay(1);
       ...
       else if(pinSetIdx == 1 && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName)))
      {
            			 mdelay(1);
            ...
            //msleep(20);
	          ...
	          else if(pinSetIdx == 0 && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName)))
	      {
	            			 mdelay(1);
		...
		if (pinSetIdx == 0 && ((0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW, currSensorName))
				||(0 == strcmp(currSensorName, SENSOR_DRVNAME_HM5040_MIPI_RAW))||(0 == strcmp(currSensorName, SENSOR_DRVNAME_HM5040MIPI_RAW))
				||(0 == strcmp(SENSOR_DRVNAME_OV8858_MIPI_RAW, currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName)))) {
			...
			if (TRUE != _hwPowerDownCnt(pinSetIdx, VCAMIO, mode_name)) {
				...
				goto _kdCISModulePowerOn_exit_;
					...
					||(0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))	||((pinSetIdx == 1)&&(0 == strcmp(SENSOR_DRVNAME_OV2680_MIPI_RAW, currSensorName)))||((pinSetIdx == 0)&&(0 == strcmp(SENSOR_DRVNAME_OV2681_MIPI_RAW, currSensorName)))||(0 == strcmp(SENSOR_DRVNAME_SP2518_YUV, currSensorName)))){
			/* Set Power Pin low and Reset Pin Low */
			/* Set Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
