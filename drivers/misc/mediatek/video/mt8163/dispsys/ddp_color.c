...
static void ddp_color_cal_split_window(DISP_MODULE_ENUM module, unsigned int *p_split_window_x,
...
static void ddp_color_set_window(DISP_MODULE_ENUM module, DISP_PQ_WIN_PARAM *win_param, void *__cmdq)
{
	const int offset = C0_OFFSET;
	cmdqRecHandle cmdq = (cmdqRecHandle)__cmdq;
	unsigned int split_window_x, split_window_y;
	...
	COLOR_DBG("ddp_color_set_window(), input: en[%d], x[0x%x], y[0x%x]\n",
		g_split_en, ((win_param->end_x << 16) | win_param->start_x),
