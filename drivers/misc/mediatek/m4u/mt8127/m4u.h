...
/*
 * We do not need to backup security register for mt8127, but SMI Variant will
 * need those interface to pass the build, the following interface are just for
 * smi driver use
 */
static inline int m4u_larb_backup_sec(int larb)
{
	return 0;
}

static inline int m4u_larb_restore_sec(int larb)
{
	return 0;
}
