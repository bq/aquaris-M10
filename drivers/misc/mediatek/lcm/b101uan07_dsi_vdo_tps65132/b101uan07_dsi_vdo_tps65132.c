...
#ifdef CONFIG_LCM_POWER_CONTROL_GPIO
#define LCD_CONTROL_PIN
#define LCD_RESET_NOT_USED
#else
//#define LCD_CONTROL_PIN
#endif
...
#ifdef  CONFIG_LCM_POWER_OFF_LATER
static void lcm_suspend_power_later(void)
{
printk("---LCM_DRIVER---lcm_suspend_power_later---\n");
...
#ifndef  CONFIG_LCM_POWER_OFF_LATER
...
//set lcm power earlier, added by xmwwy
#ifdef CONFIG_LCM_POWER_SET_EARLY
static void lcm_resume_power_early(void)
{
     printk("---LCM_DRIVER---lcm_resume_power_early---\n");
#ifdef CONFIG_LCM_POWER_CONTROL_GPIO
     lcm_resume_power();
     MDELAY(15);
#else
...
#ifndef CONFIG_LCM_POWER_SET_EARLY
#ifdef CONFIG_LCM_POWER_CONTROL_GPIO
    lcm_resume_power();
	MDELAY(15);
#else
...
LCM_DRIVER b101uan07_dsi_vdo_tps65132_lcm_drv = 
{
	...
	.suspend			= lcm_suspend,
#ifdef CONFIG_LCM_POWER_OFF_LATER
	.suspend_power     = lcm_suspend_power_later,
#endif
#ifdef CONFIG_LCM_POWER_SET_EARLY
	.resume_power	= lcm_resume_power_early,
#endif
	.resume			= lcm_resume,
};
