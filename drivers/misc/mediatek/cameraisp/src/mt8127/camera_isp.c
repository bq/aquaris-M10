...
static MINT32 ISP_DumpReg(MVOID)
{
	...
	for (i = 0x0; i <= 0x20; i += 4) {
		/* LOG_ERR("0x%08X %08X ", ISP_ADDR + i, ISP_RD32(ISP_ADDR + i)); */
		LOG_ERR("0x%08X %08X ", ISP_ADDR + i, ISP_RD32(ISP_ADDR + i));
	}
	/* ignore read clear registers */
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x24, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x28, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x2C, ISP_RD32(ISP_ADDR + 0x2C));
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x30, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x34, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x38, ISP_RD32(ISP_ADDR + 0x38));
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x3C, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x40, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x44, 0);
	LOG_ERR("0x%08X %08X ", ISP_ADDR + 0x48, 0);
	...
	LOG_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x050, ISP_RD32((void *)(ISP_ADDR + 0x050)));
	...
	LOG_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0A8, ISP_RD32((void *)(ISP_ADDR + 0x0A8)));
	...
	LOG_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0E8, ISP_RD32((void *)(ISP_ADDR + 0x0E8)));
	...
	for (i = 0x44; i <= 0x48; i += 4)
		LOG_ERR("0x%08X %08X ", (unsigned int)(ISP_ADDR + i), (unsigned int)ISP_RD32((void *)(ISP_ADDR + i)));
	...
	/* CDP */
	LOG_ERR("0x%08X %08X ", (unsigned int)(ISP_ADDR + 0xCC0), (unsigned int)ISP_RD32((void *)(ISP_ADDR + 0xCC0)));
	LOG_ERR("0x%08X %08X ", (unsigned int)(ISP_ADDR + 0xD40), (unsigned int)ISP_RD32((void *)(ISP_ADDR + 0xD40)));
	...
	LOG_ERR("0x%08X %08X ", (unsigned int)(ISP_ADDR_CAMINF), (unsigned int)ISP_RD32((void *)ISP_ADDR_CAMINF));
	LOG_ERR("0x%08X %08X ", (unsigned int)(ISP_ADDR + 0x150), (unsigned int)ISP_RD32((void *)(ISP_ADDR + 0x150)));
...
*
********************************************************************************/
static ssize_t ISP_DumpRegToProc(struct seq_file *s, void *v)
{
	MUINT32 i = 0;
...
static ssize_t CAMIO_DumpRegToProc(struct seq_file *s, void *v)
{
	LOG_WRN("Not support");
	return 0;
}
