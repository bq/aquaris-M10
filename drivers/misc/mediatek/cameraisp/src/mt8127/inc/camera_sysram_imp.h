...
#define	LOG_MSG(format,	args...)    pr_debug(LOG_TAG "[%s]" format "\n", __func__, ##args)
#define LOG_WRN(format, args...)    pr_warn(LOG_TAG "[%s, line%05d]Warning:" format "\n", __func__, __LINE__, ##args)
#define LOG_ERR(format, args...)    pr_err(LOG_TAG "[%s, line%05d]ERROR:" format "\n", __func__, __LINE__, ##args)
#define LOG_DMP(format, args...)    pr_alert(LOG_TAG "[%s, line%05d]ASSERT:" format "\n", __func__, __LINE__, ##args)
/* ----------------------------------------------------------------------------- */
