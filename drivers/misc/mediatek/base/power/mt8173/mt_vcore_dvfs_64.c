...
#else
#define vcorefs_emerg(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_alert(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_crit(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_err(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_warn(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_notice(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_info(fmt, args...)	pr_info(fmt, ##args)
#define vcorefs_debug(fmt, args...)	pr_info(fmt, ##args)	/* pr_debug show nothing */
#endif
