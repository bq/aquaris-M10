...
static const struct of_device_id mfg_dt_ids[] = {
	{.compatible = "mediatek,mt8167-mfg"}
};
...
{
	print_debug("@%s: [Before] noncache_dummy_src[0] = %d, noncache_dummy_dst[0] = %d\n",
	...
	print_debug("@%s: [After] noncache_dummy_src[0] = %d, noncache_dummy_dst[0] = %d\n",
		   __func__, noncache_dummy_src[0], noncache_dummy_dst[0]);
}
