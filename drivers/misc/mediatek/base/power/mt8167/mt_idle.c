...
static void __init iomap_init(void)
{
	...
	get_base_from_node("mediatek,mt8167-infracfg", &infrasys_base, 0);
	get_base_from_node("mediatek,mt8167-audiosys", &audiosys_base, 0);
	get_base_from_node("mediatek,mt8167-mfg", &mfgsys_base, 0);
	...
	get_base_from_node("mediatek,mt8167-vencsys", &vencsys_base, 0);
