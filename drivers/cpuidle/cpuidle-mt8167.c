...
static struct cpuidle_driver mt8167_cpuidle_driver = {
	.name             = "mt8167_cpuidle",
	.owner            = THIS_MODULE,
	.states[0] = {
...
static const struct of_device_id mt8167_idle_state_match[] __initconst = {
 ...
 */
int __init mt8167_cpuidle_init(void)
{
	int cpu, ret;
	struct cpuidle_driver *drv = &mt8167_cpuidle_driver;
...
int __init mt8167_cpuidle_init(void)
{
	return cpuidle_register(&mt8167_cpuidle_driver, NULL);
}
#endif

device_initcall(mt8167_cpuidle_init);
